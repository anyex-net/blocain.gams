...
/**
 * 合伙企业协议纰漏信息 实体对象
 * <p>File：AccountParAgreement.java</p>
 * <p>Title: AccountParAgreement</p>
 * <p>Description:AccountParAgreement</p>
...
@ApiModel(description = "合伙企业协议纰漏信息")
public class AccountParAgreement extends GenericEntity {
	...
	/**状态 1是true 0是false*/
	@NotNull(message = "状态 1是true 0是false不可为空")
