...
/**
 * IB账户市值历史表 实体对象
 * <p>File：IbAccountMarketValueHis.java</p>
 * <p>Title: IbAccountMarketValueHis</p>
 * <p>Description:IbAccountMarketValueHis</p>
...
@ApiModel(description = "IB账户市值历史表")
public class IbAccountMarketValueHis extends GenericEntity {
	...
	/*******************查询参数********************/
	private java.lang.Long createDateStart;

	private java.lang.Long createDateEnd;
