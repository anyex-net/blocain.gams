 ...
 */
@Data
@ApiModel(description = "公司个人信息 + 字典")
@Accessors(chain = true)
public class AccountCoPersonalModel {
     ...
     * @return
     */
    public AccountCoPersonal convertToEntity(){
        AccountCoPersonalModel.ModelConvert modelConvert = new AccountCoPersonalModel.ModelConvert();
        AccountCoPersonal entity = modelConvert.convert(this);
        return entity;
    }
     ...
     * @return
     */
    public AccountCoPersonalModel convertToModel(AccountCoPersonal entity){
        AccountCoPersonalModel.ModelConvert modelConvert = new AccountCoPersonalModel.ModelConvert();
        AccountCoPersonalModel model = modelConvert.reverse().convert(entity);
        return model;
    }

    private class ModelConvert extends Converter<AccountCoPersonalModel, AccountCoPersonal> {
        @Override
        protected AccountCoPersonal doForward(AccountCoPersonalModel model) {
            AccountCoPersonal entity = new AccountCoPersonal();
            BeanUtils.copyProperties(model, entity);
            return entity;
        }

        @Override
        protected AccountCoPersonalModel doBackward(AccountCoPersonal entity) {
            AccountCoPersonalModel model = new AccountCoPersonalModel();
