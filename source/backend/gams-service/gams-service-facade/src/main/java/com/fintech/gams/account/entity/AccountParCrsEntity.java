...
/**
 * 合伙企业CRS实体自我证明表格(CRS-CP) 实体对象
 * <p>File：AccountParCrsEntity.java</p>
 * <p>Title: AccountParCrsEntity</p>
 * <p>Description:AccountParCrsEntity</p>
...
@ApiModel(description = "合伙企业CRS实体自我证明表格(CRS-CP)")
public class AccountParCrsEntity extends GenericEntity {
