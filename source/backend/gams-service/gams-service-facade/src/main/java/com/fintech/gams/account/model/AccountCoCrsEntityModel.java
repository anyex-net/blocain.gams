...
@ApiModel(description = "公司CRS实体自我证明表格 + 字典信息 ")
public class AccountCoCrsEntityModel extends GenericEntity {
    ...
    private List<AccountCoCrsEntityContr> accountCoCrsEntityContrs;

    /**
     * 复制 model 到 entity
     * @return
     */
    public AccountCoCrsEntity convertToEntity(){
        AccountCoCrsEntityModel.ModelConvert modelConvert = new AccountCoCrsEntityModel.ModelConvert();
        AccountCoCrsEntity entity = modelConvert.convert(this);
        return entity;
    }
     ...
     * @return
     */
    public AccountCoCrsEntityModel convertToModel(AccountCoCrsEntity entity){
        AccountCoCrsEntityModel.ModelConvert modelConvert = new AccountCoCrsEntityModel.ModelConvert();
        AccountCoCrsEntityModel model = modelConvert.reverse().convert(entity);
        return model;
    }

    private class ModelConvert extends Converter<AccountCoCrsEntityModel, AccountCoCrsEntity> {
        @Override
        protected AccountCoCrsEntity doForward(AccountCoCrsEntityModel model) {
            AccountCoCrsEntity entity = new AccountCoCrsEntity();
            BeanUtils.copyProperties(model, entity);
            return entity;
        }

        @Override
        protected AccountCoCrsEntityModel doBackward(AccountCoCrsEntity entity) {
