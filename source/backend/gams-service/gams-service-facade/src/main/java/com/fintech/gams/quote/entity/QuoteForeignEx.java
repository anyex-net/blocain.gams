...
/**
 * 外汇行情 实体对象
 * <p>File：QuoteForeignEx.java</p>
 * <p>Title: QuoteForeignEx</p>
 * <p>Description:QuoteForeignEx</p>
...
@ApiModel(description = "外汇行情")
public class QuoteForeignEx extends GenericEntity
{
    ...
    /**52周最高价*/
    @ApiModelProperty(value = "52周最高价")
    private java.math.BigDecimal high52week;
    
    /**52周最低价*/
    @ApiModelProperty(value = "52周最低价")
    private java.math.BigDecimal low52week;
