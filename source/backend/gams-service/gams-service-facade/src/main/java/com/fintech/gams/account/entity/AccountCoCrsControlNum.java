...
/**
 * 公司CRS控权人自我证明控权人编号 实体对象
 * <p>File：AccountCoCrsControlNum.java</p>
 * <p>Title: AccountCoCrsControlNum</p>
 * <p>Description:AccountCoCrsControlNum</p>
...
@ApiModel(description = "公司CRS控权人自我证明控权人编号")
public class AccountCoCrsControlNum extends GenericEntity {
	...
	@JsonSerialize(using = ToStringSerializer.class)
	private Long coCrsEntityContrId;
