...
/**
 * 热门外汇行情对象
 * <p>File: HotForeignExQuote.java </p>
 * <p>Title: HotForeignExQuote </p>
 * <p>Description: HotForeignExQuote </p>
 ...
 */
@Data
@ApiModel(description = "热门外汇行情对象")
public class HotForeignExQuote implements Serializable
{
    /**证券信息ID*/
