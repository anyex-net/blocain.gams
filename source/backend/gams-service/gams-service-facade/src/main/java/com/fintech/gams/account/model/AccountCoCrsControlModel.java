...
@ApiModel(description = "有限公司CRS控权人自我证明表格 + 地址 ")
public class AccountCoCrsControlModel extends GenericEntity {
    /**账户ID*/
     ...
     * @return
     */
    public AccountCoCrsControl convertToEntity(){
        AccountCoCrsControlModel.ModelConvert modelConvert = new AccountCoCrsControlModel.ModelConvert();
        AccountCoCrsControl entity = modelConvert.convert(this);
        return entity;
    }
     ...
     * @return
     */
    public AccountCoCrsControlModel convertToModel(AccountCoCrsControl entity){
        AccountCoCrsControlModel.ModelConvert modelConvert = new AccountCoCrsControlModel.ModelConvert();
        AccountCoCrsControlModel model = modelConvert.reverse().convert(entity);
        return model;
    }

    private class ModelConvert extends Converter<AccountCoCrsControlModel, AccountCoCrsControl> {
        @Override
        protected AccountCoCrsControl doForward(AccountCoCrsControlModel model) {
            AccountCoCrsControl entity = new AccountCoCrsControl();
            BeanUtils.copyProperties(model, entity);
            return entity;
        }

        @Override
        protected AccountCoCrsControlModel doBackward(AccountCoCrsControl entity) {
