...
<#--    </table>-->
    ...
    <table border="1" cellpadding="0" cellspacing="0">
        <tr>
            <td>Salutation称呼</td>
            <td colspan="3">
                ${(authorizedPersons[0].accountParPersonal.appellation.dictDest)!}
            </td>
        </tr>
        <tr>
            <td style="width: 170px;">
                <div>Last Name姓</div>
                <div>
                    ${(authorizedPersons[0].accountParPersonal.lastName)!}
                </div>
            </td>
            <td style="width: 170px;">
                <div>Middle Name(s)中间名*</div>
                <div>
                    ${(authorizedPersons[0].accountParPersonal.middleName)!}
                </div>
            </td>
            <td style="width: 150px;">
                <div>First Name名</div>
                <div>
                    ${(authorizedPersons[0].accountParPersonal.firstName)!}
                </div>
            </td>
            <td>
                <div>Suffix后缀*</div>
                <div>
                    ${(authorizedPersons[0].accountParPersonal.suffix)!}
                </div>
            </td>
        </tr>
        <tr>
            <td colspan="2">
                ...
                <div>
                    ${(authorizedPersons[0].accountParPersonal.birthday)!"N/A"}
                </div>
            </td>
            <td colspan="2">
                <div>Position职位</div>
                <div>
                    <#if (authorizedPersons[0].accountParPersonal.companyPosition[0].dictDest) ?? &&authorizedPersons[0].accountParPersonal.companyPosition[0].dictDest == "mishu">
                        secretary
                    <#elseif (authorizedPersons[0].accountParPersonal.companyPosition[0].dictDest) ?? &&authorizedPersons[0].accountParPersonal.companyPosition[0].dictDest == "dongshi">
                        director
                    <#else >
                        ${(authorizedPersons[0].accountParPersonal.companyPosition[0].dictDest?replace('qitaguanyuan,',''))!}
                    </#if>
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td colspan="3" class="valueTd">
                <#list authorizedPersons[0].accountParAddressList as address>
        ...
        <tr>
            ...
            <td colspan="2">
                <div class="valueTd">
                    ${(authorizedPersons[0].accountParAddressList[0].otherCountry.enName)!"N/A"}
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td colspan="2">
                <div class="valueTd">
                    ${(authorizedPersons[0].accountParAddressList[0].otherBirthCountry.enName)!"N/A"}
                </div>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td colspan="3">
                <div class="valueTd">
                    ${(authorizedPersons[0].accountParPersonal.email)!}
                </div>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td>${(authorizedPersons[0].accountParContactList[0].contactNumberType.dictDest)!"N/A"}</td>
            <td>${(authorizedPersons[0].accountParContactList[0].country.enName)!"N/A"}</td>
            <td colspan="2">${(authorizedPersons[0].accountParContactList[0].contactNumber)!"N/A"}</td>
        </tr>
        <tr>
            <td>${(authorizedPersons[0].accountParContactList[1].contactNumberType.dictDest)!"N/A"}</td>
            <td>${(authorizedPersons[0].accountParContactList[1].country.enName)!"N/A"}</td>
            <td colspan="2">${(authorizedPersons[0].accountParContactList[1].contactNumber)!"N/A"}</td>
        </tr>
        <tr>
            <td>${(authorizedPersons[0].accountParContactList[2].contactNumberType.dictDest)!"N/A"}</td>
            <td>${(authorizedPersons[0].accountParContactList[2].country.enName)!"N/A"}</td>
            <td colspan="2">${(authorizedPersons[0].accountParContactList[2].contactNumber)!"N/A"}</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td colspan="3" class="valueTd">
                ${(authorizedPersons[0].accountParIdentityList[0].idCardType.dictDest)!"N/A"}
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td class="valueTd">
                ${(authorizedPersons[0].accountParIdentityList[0].issuingCountry.enName)!"N/A"}
            </td>
            <td>
            ...
            <td class="valueTd">
                ${(authorizedPersons[0].accountParIdentityList[0].idNumber)!"N/A"}
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td colspan="3">
                <div class="valueTd">
                    ${(authorizedPersons[0].accountParTaxesList[0].taxResidenceCountry.enName)!"N/A"}
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td colspan="3">
                <div class="valueTd">
                    <#if (authorizedPersons[0].accountParTaxesList[0].taxResidenceIdCardNumber) ?? && authorizedPersons[0].accountParTaxesList[0].taxResidenceIdCardNumber !="N.A." >
                        YES
                    <#else >
                        NO
                    </#if>
        ...
        <tr>
            ...
            <td colspan="3">
                <div class="valueTd">
                    <#if authorizedPersons[0].accountParTaxesList[0].taxResidenceIdCardNumber ?? && authorizedPersons[0].accountParTaxesList[0].taxResidenceIdCardNumber !="N.A.">
                        ${(authorizedPersons[0].accountParTaxesList[0].taxResidenceIdCardNumber)!"N/A"}
                    <#else >
                        N/A
                    </#if>
                </div>
        ...
        <tr>
            ...
            <td colspan="3">
                <div class="valueTd">
                    ${(authorizedPersons[0].accountParTaxesList[0].noTaxIdentificationNumber.dictDest)!"N/A"}
                </div>
            </td>
        </tr>
    </table>
...
<!--        </tr>-->
    ...
    <table border="1" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td>
                <div>is the institution a member of the exchange, regulatory/self-regulatory authority, or a relevant or related person who is a member of the
                    exchange?</div>
        ...
        <tr>
            <td>
                <div>Whether the organization has a person in charge, a manager, an authorized trader, or other person listed in the account
        ...
        <tr>
            <td>
                <div>Whether the account holder or any of its officials is a listed company: i) a director, ii) a shareholder holding a 10% share, or iii) a
                    decision maker?</div>
    ...
    <table border="1" cellpadding="0" cellspacing="0">
        <tr>
            <td>Salutation称呼</td>
            <td colspan="3">
                ${(beneficiaryOwner.operationPrincipalList[0].accountParPersonal.appellation.dictDest)!"N/A"}
            </td>
        </tr>
        <tr>
            <td>
                <div>Last Name姓</div>
                <div>
                    ${(beneficiaryOwner.operationPrincipalList[0].accountParPersonal.lastName)!"N/A"}
                </div>
            </td>
            <td style="width: 200px;">
                <div>Middle Name(s)中间名*</div>
                <div>
                    ${(beneficiaryOwner.operationPrincipalList[0].accountParPersonal.middleName)!"N/A"}
                </div>
            </td>
            <td style="width: 180px;">
                <div>First Name名</div>
                <div>
                    ${(beneficiaryOwner.operationPrincipalList[0].accountParPersonal.firstName)!"N/A"}
                </div>
            </td>
            <td style="width: 200px;">
                <div>Suffix后缀*</div>
                <div>
                    ${(beneficiaryOwner.operationPrincipalList[0].accountParPersonal.suffix)!"N/A"}
                </div>
            </td>
        </tr>
        <tr>
            <td colspan="2">
                <div>Position职位</div>
                <div>
                    ${(beneficiaryOwner.operationPrincipalList[0].accountParPersonal.position)!"N/A"}
                </div>
            </td>
            <td colspan="2">
                <div>Date of Birth出生日期</div>
                <div>
                    ${(beneficiaryOwner.operationPrincipalList[0].accountParPersonal.birthday)!"N/A"}
                </div>
            </td>
        </tr>
        <tr>
            <td colspan="4">
                ...
                <div class="valueTd" style="height: 64px;">
                    <#list beneficiaryOwner.operationPrincipalList[0].accountParAddressList as address>
                        <#if (address.addressType) ?? && address.addressType == "personalAddress">
        ...
        <tr>
            <td colspan="2">
                ...
                <div class="valueTd" style="height: 18px">
                    ${(beneficiaryOwner.operationPrincipalList[0].accountParAddressList[0].otherCountry.enName)!"NO"}
                </div>
            </td>
            <td colspan="2">
                <div>Country of Birth (if different from above)*</div>
                <div>出生国与上方国家不同*</div>
                <div class="valueTd" style="height: 18px">
                    ${(beneficiaryOwner.operationPrincipalList[0].accountParAddressList[0].otherBirthCountry.enName)!"NO"}
                </div>
            </td>
        </tr>
        <tr>
...
<#--            </td>-->
            <td colspan="4">
                ...
                <div class="valueTd" style="height: 36px;">
                    ${(beneficiaryOwner.operationPrincipalList[0].accountParIdentityList[0].idCardType.dictDest)!"N/A"}
                </div>
            </td>
        </tr>
        <tr>
            <td colspan="4">
                ...
                <div class="valueTd">
                    ${(beneficiaryOwner.operationPrincipalList[0].accountParIdentityList[0].issuingCountry.enName)!"N/A"}
                </div>
            </td>
        </tr>
        <tr>
            <td colspan="4">
                <div>Number 号码</div>
                <div class="valueTd">
                    ${(beneficiaryOwner.operationPrincipalList[0].accountParIdentityList[0].idNumber)!"N/A"}
                </div>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td colspan="3">
                <div class="valueTd">
                    ${(beneficiaryOwner.operationPrincipalList[0].accountParTaxesList[0].taxResidenceCountry.enName)!"N/A"}
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td colspan="3">
                <div class="valueTd">
                    <#if (beneficiaryOwner.operationPrincipalList[0].accountParTaxesList[0].taxResidenceIdCardNumber) ?? && beneficiaryOwner.operationPrincipalList[0].accountParTaxesList[0].taxResidenceIdCardNumber !="N.A." >
                        YES
                    <#else >
                        NO
                    </#if>
        ...
        <tr>
            ...
            <td colspan="3">
                <div class="valueTd">
                    ${(beneficiaryOwner.operationPrincipalList[0].accountParTaxesList[0].taxResidenceIdCardNumber)!"N/A"}
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td colspan="3">
                <div class="valueTd">
                    ${(beneficiaryOwner.operationPrincipalList[0].accountParTaxesList[0].noTaxIdentificationNumber.dictDest)!"N/A"}
                </div>
            </td>
        </tr>
    </table>
...
<#--    <br />-->
        ...
        <tr>
            <td colspan="4">
                <div>First 10% or Greater Shareholder (individual or entity)</div>
        ...
        <tr>
            <td colspan="4">
                ...
                <div style="height: 36px;">
                    <#if per.accountParPersonal.personalType.dictValue == "legalPersonShareholder">
                        ${(per.accountParPersonal.entityName)!"N/A"}
                    <#else >
                        ${(per.accountParPersonal.lastName)!"N/A"}
                        ${(per.accountParPersonal.middleName)!}
                        ${(per.accountParPersonal.firstName)!}
                        ${(per.accountParPersonal.suffix)!}
                    </#if>
                </div>
            </td>
        </tr>
        <tr>
            <td colspan="4">
                ...
                <div>
                    ${(per.accountParPersonal.prcentageOfOwnership+"%")!"N/A"}
                </div>
            </td>
        </tr>
        <tr>
            <td colspan="4">
                <div>Address 地址</div>
                <div style="height: 36px;">
                    <#list per.accountParAddressList as address>
                        <#if (address.addressType) ?? && address.addressType == "personalAddress">
                            ${(address.address)!"N/A"}
                            <#break >
                        </#if>
        ...
        <tr>
            <td>${(per.accountParContactList[0].contactNumberType.dictDest)!"N/A"}</td>
            <td>${(per.accountParContactList[0].country.enName)!"N/A"}</td>
            <td>${(per.accountParContactList[0].contactNumber)!"N/A"}</td>
        </tr>
        <tr>
            <td>${(per.accountParContactList[1].contactNumberType.dictDest)!"N/A"}</td>
            <td>${(per.accountParContactList[1].country.enName)!"N/A"}</td>
            <td>${(per.accountParContactList[1].contactNumber)!"N/A"}</td>
        </tr>
        <tr>
            <td>${(per.accountParContactList[2].contactNumberType.dictDest)!"N/A"}</td>
            <td>${(per.accountParContactList[2].country.enName)!"N/A"}</td>
            <td>${(per.accountParContactList[2].contactNumber)!"N/A"}</td>
        </tr>
        <tr>
            <td>${(per.accountParContactList[3].contactNumberType.dictDest)!"N/A"}</td>
            <td>${(per.accountParContactList[3].country.enName)!"N/A"}</td>
            <td>${(per.accountParContactList[3].contactNumber)!"N/A"}</td>
        </tr>
        <tr>
            <td>${(per.accountParContactList[4].contactNumberType.dictDest)!"N/A"}</td>
            <td>${(per.accountParContactList[4].country.enName)!"N/A"}</td>
            <td>${(per.accountParContactList[4].contactNumber)!"N/A"}</td>
        </tr>
        <tr>
            <td colspan="4">Tax Residency税务居住地</td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="3">
                <div class="valueTd">
                    <#if (per.accountParTaxesList[0].taxResidenceIdCardNumber) ?? && per.accountParTaxesList[0].taxResidenceIdCardNumber !="N.A." >
                        YES
                    <#else >
                        NO
                    </#if>
        ...
        <tr>
            ...
            <td colspan="3">
                <div class="valueTd">
                    <#if per.accountParTaxesList[0].taxResidenceIdCardNumber ?? &&per.accountParTaxesList[0].taxResidenceIdCardNumber !="N.A.">
                        ${(per.accountParTaxesList[0].taxResidenceIdCardNumber)!"N/A"}
                    <#else >
                        N/A
                    </#if>
                </div>
        ...
        <tr>
            ...
            <td colspan="3">
                <div class="valueTd">
                    ${(per.accountParTaxesList[0].noTaxIdentificationNumber.dictDest)!"N/A"}
                </div>
            </td>
        </tr>
    </table>
    ...
    <table border="1" cellpadding="0" cellspacing="0" style="margin-bottom: 101px;">
        ...
        <tr>
            ...
            <td colspan="3">
                <#if per.accountParPersonal.personalType.dictValue != "legalPersonShareholder">
                    ${(per.accountParPersonal.birthday)!"N/A"}
                <#else >
                    N/A
                </#if>
            </td>
        ...
        <tr>
            ...
            <td colspan="2" class="valueTd">
                <#if per.accountParPersonal.personalType.dictValue != "legalPersonShareholder">
                    ${(per.accountParAddressList[0].otherCountry.enName)!"NO"}
                <#else >
                    N/A
                </#if>
            </td>
        ...
        <tr>
            ...
            <td colspan="2" class="valueTd">
                <#if per.accountParPersonal.personalType.dictValue != "legalPersonShareholder">
                    ${(per.accountParAddressList[0].otherBirthCountry.enName)!"NO"}
                <#else >
                    N/A
                </#if>
            </td>
            ...
            <td colspan="4">
                ...
                <table border="1" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td colspan="3" class="valueTd">
                            <#if per.accountParPersonal.personalType.dictValue != "legalPersonShareholder">
                                ${(per.accountParIdentityList[0].idCardType.dictDest)!"N/A"}
                            <#else >
                                N/A
                            </#if>
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="width: 150px">
                            <div class="valueTd">
                                <#if per.accountParPersonal.personalType.dictValue != "legalPersonShareholder">
                                    ${(per.accountParIdentityList[0].issuingCountry.enName)!"N/A"}
                                <#else >
                                    N/A
                                </#if>
                            </div>
                        ...
                        <td>
                            <div class="valueTd">
                                <#if per.accountParPersonal.personalType.dictValue != "legalPersonShareholder">
                                    ${(per.accountParIdentityList[0].idNumber)!"N/A"}
                                <#else >
                                    N/A
                                </#if>
                            </div>
        ...
        <tr>
            ...
            <td colspan="3">
                <#if per.accountParPersonal.personalType.dictValue == "legalPersonShareholder">
                    ${(per.accountParContactList[0].foundingCountry.enName)!"N/A"}
                <#else >
                    N/A
                </#if>
            </td>
        ...
        <tr>
            ...
            <td colspan="3">
                <#if per.accountParPersonal.personalType.dictValue == "legalPersonShareholder">
                    ${(per.accountParPersonal.appellation.dictDest)!"N/A"}
                <#else >
                    N/A
                </#if>
            </td>
        ...
        <tr>
            ...
            <td style="width: 170px;">
                ...
                <div>
                    <#if per.accountParPersonal.personalType.dictValue == "legalPersonShareholder">
                        ${(per.accountParPersonal.middleName)!"N/A"}
                    <#else >
                        N/A
                    </#if>
                </div>
            ...
            <td style="width: 170px;">
                ...
                <div>
                    <#if per.accountParPersonal.personalType.dictValue == "legalPersonShareholder">
                        ${(per.accountParPersonal.firstName)!"N/A"}
                    <#else >
                        N/A
                    </#if>
                </div>
            ...
            <td>
                ...
                <div>
                    <#if per.accountParPersonal.personalType.dictValue == "legalPersonShareholder">
                        ${(per.accountParPersonal.suffix)!"N/A"}
                    <#else >
                        N/A
                    </#if>
                </div>
...
<#--                <div>-->
<#--                    <#if per.accountParPersonal.personalType.dictValue == "legalPersonShareholder">-->
<#--                        ${(per.accountParPersonal.birthday?number_to_datetime?string('MM-dd-yyyy'))!"N/A"}-->
<#--                    <#else >-->
<#--                        N/A-->
<#--                    </#if>-->
<#--                </div>-->
<#--            </td>-->
            <td colspan="4">
                ...
                <div style="height: 24px;">
                    <#if per.accountParPersonal.personalType.dictValue == "legalPersonShareholder">
                        ${(per.accountParPersonal.email)!"N/A"}
                    <#else >
                        N/A
                    </#if>
                </div>
        ...
        <tr>
            <td colspan="3">
                ...
                <table border="1" cellpadding="0" cellspacing="0">
                    <tr>
                        <td style="width: 100%;">
                            ${(per.accountParContactList[0].exchange)!"N/A"}
                        </td>
                    </tr>
                </table>
                <br />
                ...
                <table border="1" cellpadding="0" cellspacing="0">
                    <tr>
                        <td style="width: 100%;">
                            ${(per.accountParContactList[0].code)!"N/A"}
                        </td>
                    </tr>
                </table>
                <br />
            ...
            <td>
                <#if per.accountParContactList[0].status ?? && per.accountParContactList[0].status == true>
                    YES
                <#else >
                    NO
                </#if>
