...
import com.fintech.gams.model.Table;
import com.fintech.gams.provider.DbModelHelper;
import com.fintech.gams.provider.DbTableProvider;
...
public class GeneratorFile
{
    ...
    // 相对于项目的地址
    String        path      = "gams-commons/gams-commons-generator/src/main/resources/template/crud";
