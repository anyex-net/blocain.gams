...
import com.fintech.gams.utils.DatabaseDataTypesUtils;
import com.fintech.gams.utils.StringHelper;
...
public class Column
{
    ...
    {
        return StringHelper.makeAllWordFirstLetterLowCase(getSqlName());
    }
