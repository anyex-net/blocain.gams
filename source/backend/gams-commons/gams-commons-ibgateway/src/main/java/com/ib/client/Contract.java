...
public class Contract implements Cloneable
{
    ...
    private String               m_primaryExch;                   // pick a non-aggregate (ie not the SMART exchange) exchange that the contract trades on. DO NOT SET TO
                                                                  // SMART.
    ...
    public Contract(int p_conId, String p_symbol, String p_secType, String p_lastTradeDateOrContractMonth, double p_strike, String p_right, String p_multiplier,
            String p_exchange, String p_currency, String p_localSymbol, String p_tradingClass, List<ComboLeg> p_comboLegs, String p_primaryExch, boolean p_includeExpired,
    ...
    public boolean equals(Object p_other)
    {
        ...
        if (!"BOND".equals(m_secType))
        {
            ...
            { return false; }
            if (Util.StringCompare(m_lastTradeDateOrContractMonth, l_theOther.m_lastTradeDateOrContractMonth) != 0 || Util.StringCompare(m_right, l_theOther.m_right) != 0
