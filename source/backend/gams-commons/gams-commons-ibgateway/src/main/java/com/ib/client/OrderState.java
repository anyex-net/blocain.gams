...
public class OrderState
{
    ...
    OrderState(String status, String initMarginBefore, String maintMarginBefore, String equityWithLoanBefore, String initMarginChange, String maintMarginChange,
            String equityWithLoanChange, String initMarginAfter, String maintMarginAfter, String equityWithLoanAfter, double commission, double minCommission,
            double maxCommission, String commissionCurrency, String warningText, String completedTime, String completedStatus)
    {
        m_status = status;
    ...
    public boolean equals(Object other)
    {
        ...
        { return false; }
        if (Util.StringCompare(m_status, state.m_status) != 0 || Util.StringCompare(m_initMarginBefore, state.m_initMarginBefore) != 0
                || Util.StringCompare(m_maintMarginBefore, state.m_maintMarginBefore) != 0 || Util.StringCompare(m_equityWithLoanBefore, state.m_equityWithLoanBefore) != 0
                || Util.StringCompare(m_initMarginChange, state.m_initMarginChange) != 0 || Util.StringCompare(m_maintMarginChange, state.m_maintMarginChange) != 0
                || Util.StringCompare(m_equityWithLoanChange, state.m_equityWithLoanChange) != 0 || Util.StringCompare(m_initMarginAfter, state.m_initMarginAfter) != 0
                || Util.StringCompare(m_maintMarginAfter, state.m_maintMarginAfter) != 0 || Util.StringCompare(m_equityWithLoanAfter, state.m_equityWithLoanAfter) != 0
                || Util.StringCompare(m_commissionCurrency, state.m_commissionCurrency) != 0 || Util.StringCompare(m_completedTime, state.m_completedTime) != 0)
        { return false; }
        return true;
    }
