...
enum Liquidities
{
    None, Added("Added Liquidity"), Removed("Removed Liquidity"), RoudedOut("Liquidity Routed Out");
...
public class Execution
{
    ...
    public Execution(int p_orderId, int p_clientId, String p_execId, String p_time, String p_acctNumber, String p_exchange, String p_side, int p_shares, double p_price,
            int p_permId, int p_liquidation, int p_cumQty, double p_avgPrice, String p_orderRef, String p_evRule, double p_evMultiplier, String p_modelCode)
    {
        m_orderId = p_orderId;
