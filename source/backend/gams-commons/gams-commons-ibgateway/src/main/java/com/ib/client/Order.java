...
public class Order
{
    ...
    private int                  m_shortSaleSlot;                                // 1 if you hold the shares, 2 if they will be delivered from elsewhere. Only for
                                                                                 // Action="SSHORT
    ...
    public boolean equals(Object p_other)
    {
        ...
        { return true; }
        if (m_orderId != l_theOther.m_orderId || m_clientId != l_theOther.m_clientId || m_totalQuantity != l_theOther.m_totalQuantity || m_lmtPrice != l_theOther.m_lmtPrice
                || m_auxPrice != l_theOther.m_auxPrice || m_ocaType != l_theOther.m_ocaType || m_transmit != l_theOther.m_transmit || m_parentId != l_theOther.m_parentId
                || m_blockOrder != l_theOther.m_blockOrder || m_sweepToFill != l_theOther.m_sweepToFill || m_displaySize != l_theOther.m_displaySize
                || m_triggerMethod != l_theOther.m_triggerMethod || m_outsideRth != l_theOther.m_outsideRth || m_hidden != l_theOther.m_hidden
                || m_overridePercentageConstraints != l_theOther.m_overridePercentageConstraints || m_allOrNone != l_theOther.m_allOrNone || m_minQty != l_theOther.m_minQty
                || m_percentOffset != l_theOther.m_percentOffset || m_trailStopPrice != l_theOther.m_trailStopPrice || m_trailingPercent != l_theOther.m_trailingPercent
                || m_origin != l_theOther.m_origin || m_shortSaleSlot != l_theOther.m_shortSaleSlot || m_discretionaryAmt != l_theOther.m_discretionaryAmt
                || m_eTradeOnly != l_theOther.m_eTradeOnly || m_firmQuoteOnly != l_theOther.m_firmQuoteOnly || m_nbboPriceCap != l_theOther.m_nbboPriceCap
                || m_optOutSmartRouting != l_theOther.m_optOutSmartRouting || m_auctionStrategy != l_theOther.m_auctionStrategy
                || m_startingPrice != l_theOther.m_startingPrice || m_stockRefPrice != l_theOther.m_stockRefPrice || m_delta != l_theOther.m_delta
                || m_stockRangeLower != l_theOther.m_stockRangeLower || m_stockRangeUpper != l_theOther.m_stockRangeUpper || m_volatility != l_theOther.m_volatility
                || m_volatilityType != l_theOther.m_volatilityType || m_continuousUpdate != l_theOther.m_continuousUpdate
                ...
                || m_exemptCode != l_theOther.m_exemptCode || m_randomizePrice != l_theOther.m_randomizePrice || m_randomizeSize != l_theOther.m_randomizeSize
                || m_solicited != l_theOther.m_solicited || m_referenceContractId != l_theOther.m_referenceContractId
                || m_peggedChangeAmount != l_theOther.m_peggedChangeAmount || m_referenceChangeAmount != l_theOther.m_referenceChangeAmount
                || m_adjustedOrderType != l_theOther.m_adjustedOrderType || m_triggerPrice != l_theOther.m_triggerPrice
                || m_adjustedStopPrice != l_theOther.m_adjustedStopPrice || m_adjustedStopLimitPrice != l_theOther.m_adjustedStopLimitPrice
                || m_adjustedTrailingAmount != l_theOther.m_adjustedTrailingAmount || m_adjustableTrailingUnit != l_theOther.m_adjustableTrailingUnit
                || m_lmtPriceOffset != l_theOther.m_lmtPriceOffset || !m_softDollarTier.equals(l_theOther.m_softDollarTier) || m_cashQty != l_theOther.m_cashQty
                || m_dontUseAutoPriceForHedge != l_theOther.m_dontUseAutoPriceForHedge || m_isOmsContainer != l_theOther.m_isOmsContainer
                || m_usePriceMgmtAlgo != l_theOther.m_usePriceMgmtAlgo || m_discretionaryUpToLimitPrice != l_theOther.m_discretionaryUpToLimitPrice
                || m_filledQuantity != l_theOther.m_filledQuantity || m_refFuturesConId != l_theOther.m_refFuturesConId
                || m_autoCancelParent != l_theOther.m_autoCancelParent || m_imbalanceOnly != l_theOther.m_imbalanceOnly
                || m_routeMarketableToBbo != l_theOther.m_routeMarketableToBbo || m_parentPermId != l_theOther.m_parentPermId)
        { return false; }
        if (Util.StringCompare(m_action, l_theOther.m_action) != 0 || Util.StringCompare(m_orderType, l_theOther.m_orderType) != 0
                || Util.StringCompare(m_tif, l_theOther.m_tif) != 0 || Util.StringCompare(m_activeStartTime, l_theOther.m_activeStartTime) != 0
                || Util.StringCompare(m_activeStopTime, l_theOther.m_activeStopTime) != 0 || Util.StringCompare(m_ocaGroup, l_theOther.m_ocaGroup) != 0
                ...
                || Util.StringCompare(m_algoStrategy, l_theOther.m_algoStrategy) != 0 || Util.StringCompare(m_algoId, l_theOther.m_algoId) != 0
                || Util.StringCompare(m_scaleTable, l_theOther.m_scaleTable) != 0 || Util.StringCompare(m_modelCode, l_theOther.m_modelCode) != 0
                || Util.StringCompare(m_referenceExchangeId, l_theOther.m_referenceExchangeId) != 0 || Util.StringCompare(m_extOperator, l_theOther.m_extOperator) != 0
                ...
                || Util.StringCompare(m_autoCancelDate, l_theOther.m_autoCancelDate) != 0 || Util.StringCompare(m_shareholder, l_theOther.m_shareholder) != 0)
        { return false; }
