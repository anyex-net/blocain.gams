<template>
  <div>
    <div id="ZC-regiMain">
                ...
                <div class="formNapeContent">
                  ...
                  <div class="renzheng clearfix">
                    ...
                    <div class="right1 zhuce3ji zimuNewline">
                      {{ company9.rezheng.xing }} {{ company9.rezheng.zhongjianming }} {{ company9.rezheng.ming }} {{ company9.rezheng.suffix }} {{ company9.rezheng.companyPosition }}
                      <br>
                      {{ company9.rezheng.companyName }}
                      <br>
                      {{ company9.rezheng.location }}
                      <br>
                      {{ company9.rezheng.chenshi }}, {{ company9.rezheng.shengshi }}, {{ company9.rezheng.postcode }}
                      <br>
                      {{ company9.rezheng.state }}
                    </div>
                  </div>
                  <!-- 经营权 -->
                  <h4
                  ...
                  <div v-show="company9.isJingyinren" class="gudongTable">
                    <table border="1" cellspacing="0" cellpadding="0">
                      ...
                      <tbody>
                        <tr v-for="(item,index) in company9.tableTbady" :key="index">
                  ...
                  <div
                    v-if="company9.tableTbady.length === 0"
                    class="addBtn"
                    style="    width: 960px;
                  ...
                  <el-form-item id="radioInline">
                    <el-radio-group v-model="company9.isOne25shouyi">
                  ...
                  <div v-show="company9.isbiaoge25" class="gudongTable">
                    <table border="1" cellspacing="0" cellpadding="0">
                      <thead>
                        <tr>
                          <th>{{ $t('registerOpenAccount.openAccount.common.beneficial.common.name') }}</th> <!-- $i18n - 姓名 -->
                      ...
                      <tbody>
                        <tr v-for="(item,index) in company9.tableTbady25" :key="index">
                          <td>{{ item.compellation }}</td>
                          <td>{{ item.suoyouquan }}</td>
                          <td>
                            <div v-if="item.delBtn" class="xiaoshou deleteBtn" @click="removePersonalTypeJ(item.id)">{{ $t('registerOpenAccount.common.btn.delete') }}</div> <!-- $i18n - 删除 -->
                        ...
                        <tr>
                          ...
                          <td>{{ company9.suoyouquanZongshu1 }}%</td>
                          <td />
                        </tr>
                      </tbody>
                    </table>
                  ...
                  <el-form-item id="radioInline" style="margin-bottom:0px">
                    <el-radio-group v-model="company9.isOne25shouyi1">
                      <el-radio
                        class="zhuce3ji"
                        label="1"
                  ...
                  <div v-show="company9.isbiaoge10" class="gudongTable">
                    <table border="1" cellspacing="0" cellpadding="0">
                      <thead>
                        <tr>
                          <th>{{ $t('registerOpenAccount.openAccount.common.beneficial.common.name') }}</th> <!-- $i18n - 姓名 -->
                      ...
                      <tbody>
                        <tr v-for="(item,index) in company9.tableTbady10" :key="index">
                          <td>{{ item.compellation }}</td>
                          <td>{{ item.suoyouquan }}</td>
                          <td>
                            <div v-if="item.delBtn" class="xiaoshou deleteBtn" @click="removePersonalTypeJ(item.id)">{{ $t('registerOpenAccount.common.btn.delete') }}</div> <!-- $i18n - 删除 -->
                        ...
                        <tr>
                          <td>{{ $t('registerOpenAccount.openAccount.common.beneficial.common.sum') }}</td> <!-- $i18n - 所有权合计 -->
                          <td>{{ company9.suoyouquanZongshu2 }}%</td>
                          <td />
                        </tr>
                      </tbody>
                    </table>
                  ...
                  <div class="signature" style="margin-top: 60px;">
                    <ul class="bottom10 clearfix">
                      ...
                      <li class="left1">{{ company9.shengming.signatureZhanshi }}</li>
                    </ul>
                    <el-form-item class="zhuce3ji" prop="shengming.signature">
                      <el-input v-model="company9.shengming.signature" maxlength="128" />
                    </el-form-item>
                  </div>
                </div>
              </div>
              <!-- 提交按钮 -->
              <div v-show="company9.isbottomBox" class="formbtn">
                <div class="formbtn-content">
                  <el-form-item>
                    <el-button class="right-btn BTbtn" plain @click="submitForm('company9')">{{ $t('registerOpenAccount.footer.btnYes') }}</el-button>
      ...
      <!-- 模态框  经营人-->
      <div v-if="company9.ifmodalBox" class="modalBox">
        <div class="contentBOX">
              ...
              <div class="formContent">
                ...
                <div class="formNape">
                  <div class="formNapeContent">
                    ...
                    <el-form-item v-if="company9.ismodalBox1Cot" prop="xuanzeren1.beneficiaryName">
                      <el-select v-model="company9.xuanzeren1.beneficiaryName" :no-match-text="$t('account.manage.no_data')" :placeholder="$t('registerOpenAccount.common.formPrompt.pleaseChoose')"> <!-- $i18n - 请选择 -->
                        <el-option v-for="(item,index) in company9.xuanzeren1.beneficiaryNameList" :key="index" :label="item.SYRname" :value="item.SYRvalue" @click.native="company9.ismodalBox1Cot=true" />
                        <el-option :label="$t('registerOpenAccount.openAccount.common.beneficial.modal.notListed')" value="NotListed" @click.native="company9.ismodalBox1Cot=false" /> <!-- $i18n - 未列出 -->
                      </el-select>
                    </el-form-item>
                    <el-form-item v-if="company9.ismodalBox1Cot" prop="xuanzeren1.zhiwei">
                      <el-input v-model="company9.xuanzeren1.zhiwei" maxlength="18" :placeholder="$t('registerOpenAccount.openAccount.common.beneficial.modal.position')" /> <!-- $i18n - 职位 -->
                    </el-form-item>
                  </div>
                </div>
                <div v-if="!company9.ismodalBox1Cot">
                  <!-- 个人信息 -->
                  <div class="formNape">
                    <div class="formNapeTitle">
                    ...
                    <div class="formNapeContent">
                      <el-form-item prop="gerenGudong.companyName">
                        <el-select v-model="company9.gerenGudong.companyName" :no-match-text="$t('account.manage.no_data')" :placeholder="$t('registerOpenAccount.openAccount.common.info.appellation')"> <!-- $i18n - 称呼 -->
                          <dictionary dict-code="appellationType" />
                        </el-select>
                      </el-form-item>
                      <el-form-item prop="gerenGudong.call">
                        <el-input v-model="company9.gerenGudong.call" maxlength="50" :placeholder="$t('registerOpenAccount.openAccount.common.info.firstName')" /> <!-- $i18n - 姓 -->
                      </el-form-item>
                      <el-form-item prop="gerenGudong.middle">
                        <el-input v-model="company9.gerenGudong.middle" maxlength="50" :placeholder="$t('registerOpenAccount.openAccount.common.info.middleName')" /> <!-- $i18n - 中间名,不适用于中国客户 -->
                      </el-form-item>
                      <el-form-item prop="gerenGudong.surname">
                        <el-input v-model="company9.gerenGudong.surname" maxlength="18" :placeholder="$t('registerOpenAccount.openAccount.common.info.lastName')" /> <!-- $i18n - 名 -->
                      </el-form-item>
                      <el-form-item prop="gerenGudong.suffix">
                        <el-select v-model="company9.gerenGudong.suffix" :no-match-text="$t('account.manage.no_data')" clearable :placeholder="$t('registerOpenAccount.openAccount.common.info.suffix')"> <!-- $i18n - 后缀（不适用于中国客户） -->
                      ...
                      <div class="isBtn">
                        <ul>
                          <li
                            class="isyes"
                            :class="{ dianji: company9.gerenGudong.issuoyouquanBi}"
                            @click="company9.gerenGudong.issuoyouquanBi=true"
                          >{{ $t('registerOpenAccount.common.btn.yes') }}</li> <!-- $i18n - 是 -->
                          <li
                            class="isno"
                            :class="{ dianji: !company9.gerenGudong.issuoyouquanBi}"
                            @click="company9.gerenGudong.issuoyouquanBi=false"
                      ...
                      <el-form-item
                        v-if="company9.gerenGudong.issuoyouquanBi"
                        prop="gerenGudong.suoyouquanBi"
                        class="percentage"
                      >
                        <el-input v-model="company9.gerenGudong.suoyouquanBi" maxlength="3" :placeholder="$t('registerOpenAccount.openAccount.common.info.ownership')" /> <!-- $i18n - 所有权百分比 -->
                        <div class="icon-percent" style="left: 95.8%;">%</div>
                      </el-form-item>
                      <el-form-item prop="gerenGudong.zhiwei44">
                        <el-input v-model="company9.gerenGudong.zhiwei44" maxlength="18" :placeholder="$t('registerOpenAccount.openAccount.common.info.position.post')" /> <!-- $i18n - 职位 -->
                      </el-form-item>
                      <div class="block">
                        <el-form-item prop="gerenGudong.birth">
                          <el-date-picker
                            v-model="company9.gerenGudong.birth"
                    ...
                    <div class="formNapeContent">
                      <div>
                        <el-form-item prop="juzhudizhi.state1">
                          <el-select v-model="company9.juzhudizhi.state1" :no-match-text="$t('account.manage.no_data')" filterable :placeholder="$t('registerOpenAccount.openAccount.common.addre.state')"> <!-- $i18n - 国家 -->
                            <dictionary dict-code="country" />
                          </el-select>
                        </el-form-item>
                        <el-form-item prop="juzhudizhi.dizhi">
                          <el-input
                            v-model="company9.juzhudizhi.dizhi"
                            maxlength="64"
                            :placeholder="$t('registerOpenAccount.openAccount.common.addre.siteOne')"
                          /> <!-- $i18n - 地址 ( 如果空间不足，请转下行 ) -->
                        </el-form-item>
                        <el-form-item>
                          <el-input v-model="company9.juzhudizhi.dizhi1" maxlength="64" :placeholder="$t('registerOpenAccount.openAccount.common.addre.siteTwo')" /> <!-- $i18n - ( 接上行) 房间号, 楼层 公寓等 -->
                        </el-form-item>
                        <el-form-item prop="juzhudizhi.chengshi">
                          <el-input v-model="company9.juzhudizhi.chengshi" maxlength="24" :placeholder="$t('registerOpenAccount.openAccount.common.addre.city')" /> <!-- $i18n - 城市 -->
                        </el-form-item>
                        <el-form-item prop="juzhudizhi.province">
                          <el-input v-model="company9.juzhudizhi.province" maxlength="24" :placeholder="$t('registerOpenAccount.openAccount.common.addre.province')" /> <!-- $i18n - 省/市 -->
                        </el-form-item>
                        <el-form-item prop="juzhudizhi.youbian">
                          <el-input v-model="company9.juzhudizhi.youbian" maxlength="20" :placeholder="$t('registerOpenAccount.openAccount.common.addre.postalcode')" /> <!-- $i18n - 邮政编码 -->
                        </el-form-item>
                      </div>
                      <div class="isBtn">
                        <ul>
                          <li
                            class="isyes"
                            :class="{ dianji: company9.juzhudizhi.isguojiButong}"
                            @click="company9.juzhudizhi.isguojiButong=true"
                          >{{ $t('registerOpenAccount.common.btn.yes') }}</li> <!-- $i18n - 是 -->
                          <li
                            class="isno"
                            :class="{ dianji: !company9.juzhudizhi.isguojiButong}"
                            @click="company9.juzhudizhi.isguojiButong=false"
                          >{{ $t('registerOpenAccount.common.btn.no') }}</li> <!-- $i18n - 否 -->
                          <li class="istext">{{ $t('registerOpenAccount.openAccount.common.addre.differentNationalities1') }}</li> <!-- $i18n - 您的国籍是否与上方所选国家不同？ -->
                        </ul>
                      </div>
                      <el-form-item v-show="company9.juzhudizhi.isguojiButong" prop="juzhudizhi.guoji">
                        <el-select v-model="company9.juzhudizhi.guoji" :no-match-text="$t('account.manage.no_data')" filterable :placeholder="$t('registerOpenAccount.openAccount.common.addre.state')"> <!-- $i18n - 国家 -->
                          <dictionary dict-code="country" />
                        </el-select>
                      </el-form-item>
                      <div class="isBtn">
                        <ul>
                          <li
                            class="isyes"
                            :class="{ dianji: company9.juzhudizhi.ischushengguoButong}"
                            @click="company9.juzhudizhi.ischushengguoButong=true"
                          >{{ $t('registerOpenAccount.common.btn.yes') }}</li> <!-- $i18n - 是 -->
                          <li
                            class="isno"
                            :class="{ dianji: !company9.juzhudizhi.ischushengguoButong}"
                            @click="company9.juzhudizhi.ischushengguoButong=false"
                          >{{ $t('registerOpenAccount.common.btn.no') }}</li> <!-- $i18n - 否 -->
                          <li class="istext">{{ $t('registerOpenAccount.openAccount.common.addre.differentBirthStateDescribe1') }}</li> <!-- $i18n - 您的出生国是否与上方所选国家不同? -->
                        </ul>
                      </div>
                      <el-form-item
                        v-show="company9.juzhudizhi.ischushengguoButong"
                        prop="juzhudizhi.chushengguo"
                      >
                        <el-select v-model="company9.juzhudizhi.chushengguo" :no-match-text="$t('account.manage.no_data')" filterable :placeholder="$t('registerOpenAccount.openAccount.common.addre.butongBirthState')"> <!-- $i18n - 出生国家 -->
                          <dictionary dict-code="country" />
                        </el-select>
                      </el-form-item>
                      <div class="isBtn">
                        <ul>
                          <li
                            class="isyes"
                            :class="{ dianji: company9.juzhudizhi.isMeiguoNasuiren}"
                            @click="company9.juzhudizhi.isMeiguoNasuiren=true"
                          >{{ $t('registerOpenAccount.common.btn.yes') }}</li> <!-- $i18n - 是 -->
                          <li
                            class="isno"
                            :class="{ dianji: !company9.juzhudizhi.isMeiguoNasuiren}"
                            @click="company9.juzhudizhi.isMeiguoNasuiren=false"
                          >{{ $t('registerOpenAccount.common.btn.no') }}</li> <!-- $i18n - 否 -->
                  ...
                  <!-- 身份证明 -->
                  <div class="formNape">
                    <div v-show="!company9.juzhudizhi.isMeiguoNasuiren" class="formNape">
                      <div class="formNapeTitle">
                        <h3>{{ $t('registerOpenAccount.openAccount.common.identity.title') }}</h3> <!-- $i18n - 身份证明 -->
                      </div>
                      <div class="formNapeContent">
                        <el-form-item prop="identification.SFsignGuojia">
                          <el-select v-model="company9.identification.SFsignGuojia" :no-match-text="$t('account.manage.no_data')" filterable :placeholder="$t('registerOpenAccount.openAccount.common.identity.state')"> <!-- $i18n - v -->
                            <dictionary dict-code="country" />
                          </el-select>
                        </el-form-item>
                        <el-form-item prop="identification.SFzhengjianleixing">
                          <el-select
                            v-model="company9.identification.SFzhengjianleixing"
                        ...
                        <el-form-item prop="identification.SFzhengjianhao">
                          <el-input v-model="company9.identification.SFzhengjianhao" maxlength="63" :placeholder="$t('registerOpenAccount.openAccount.common.identity.number')" /> <!-- $i18n - 证件号码 -->
                        </el-form-item>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="formNape">
                    ...
                    <div
                      v-for="(item,index) in company9.placeAbode"
                      :key="index"
                    ...
                    <div
                      ...
                      style="    width: 960px;
                                   height: 41px;margin-top:10px;"
                    >
                      <div v-show="company9.placeAbode.length !== 5" class="add" @click="addelement3()">{{ $t('registerOpenAccount.openAccount.common.taxes.addTaxResidence') }}</div> <!-- $i18n - 添加税务居住地 -->
                      <div v-show="company9.placeAbode.length !== 1" class="cancel" @click="removeelement3()">{{ $t('registerOpenAccount.common.btn.delete') }}</div> <!-- $i18n - 删除 -->
                    </div>
                  </div>
                </div>
                <!-- 保存,关闭 -->
                <div class="isBtn right1">
                  <ul>
                    <li class="isyes Motaiteshuchuli" @click="save('company9',1)">{{ $t('registerOpenAccount.common.btn.save') }}</li> <!-- $i18n - 保存 -->
      ...
      <!-- 模态框  添加股东25-->
      <div v-if="company9.ifmodalBox1" class="modalBox">
        <div class="contentBOX">
          <div class="contentBOXdignwei contentBOXMoL">
            <el-form
              ref="company9"
              ...
              <div class="formContent">
                ...
                <div class="formNape">
                  <div class="formNapeContent">
                    ...
                    <el-form-item v-if="company9.ismodalBox2Cot" prop="xuanzeren1.beneficiaryName">
                      <el-select
                        v-model="company9.xuanzeren1.beneficiaryName"
                        :no-match-text="$t('account.manage.no_data')"
                      ...
                      > <!-- $i18n - 请选择 -->
                        <el-option
                          ...
                          value="NotListed"
                          @click.native="company9.ismodalBox2Cot=false"
                        /> <!-- $i18n - 未列出 -->
                      </el-select>
                    </el-form-item>
                    <!-- <el-form-item prop="xuanzeren1.zhiwei" v-if="company9.ismodalBox1Cot">
                      <el-input maxlength="18"  v-model="company9.xuanzeren1.zhiwei" placeholder="职位"></el-input>
                    </el-form-item>-->
                  </div>
                </div>
                <div v-if="!company9.ismodalBox2Cot">
                  <!-- 个人信息 -->
                  <div class="formNape">
                    <div class="formNapeTitle">
                      <h3>{{ $t('registerOpenAccount.openAccount.common.info.title') }}</h3> <!-- $i18n - 个人信息 -->
                  ...
                  <div class="formNape">
                    <div v-show="!company9.juzhudizhi.isMeiguoNasuiren" class="formNape">
                      ...
                      <div class="formNapeContent">
                        <el-form-item prop="identification.SFsignGuojia">
                          <el-select v-model="company9.identification.SFsignGuojia" :no-match-text="$t('account.manage.no_data')" filterable :placeholder="$t('registerOpenAccount.openAccount.common.identity.state')"> <!-- $i18n - 签发国家 -->
                            <dictionary dict-code="country" />
                          </el-select>
                        </el-form-item>
                        <el-form-item prop="identification.SFzhengjianleixing">
                ...
                <div class="isBtn right1">
                  <ul>
                    <li class="isyes Motaiteshuchuli" @click="save('company9',2)">{{ $t('registerOpenAccount.common.btn.save') }}</li> <!-- $i18n - 保存 -->
      ...
      <!-- 模态框 1 添加股东10-->
      <div v-if="company9.ifmodalBox2" class="modalBox">
        <div class="contentBOX">
          <div class="contentBOXdignwei contentBOXMoL">
            <el-form
              ref="company9"
              ...
              <div class="formContent">
                ...
                <div class="formNape">
                  <div class="formNapeContent">
                    ...
                    <el-form-item v-if="company9.ismodalBox3Cot" prop="xuanzeren1.beneficiaryName">
                      <el-select
                        v-model="company9.xuanzeren1.beneficiaryName"
                        :no-match-text="$t('account.manage.no_data')"
                        :placeholder="$t('registerOpenAccount.common.formPrompt.pleaseChoose')"
                      > <!-- $i18n - 请选择 ... -->
                        <el-option
                          :label="$t('registerOpenAccount.openAccount.common.beneficial.modal.notListed')"
                          value="NotListed"
                          @click.native="company9.ismodalBox3Cot=false"
                        /> <!-- $i18n - 未列出 ... -->
                      </el-select>
                    </el-form-item>
                    <!-- <el-form-item prop="xuanzeren1.zhiwei" v-if="company9.ismodalBox1Cot">
                ...
                <div v-if="!company9.ismodalBox3Cot">
                  <!-- 个人信息 -->
                  <div class="formNape">
                    <div class="formNapeTitle">
                      <h3>{{ $t('registerOpenAccount.openAccount.common.info.title') }}</h3> <!-- $i18n - 个人信息 -->
                    ...
                    <div class="formNapeContent">
                      ...
                      <el-form-item prop="gerenGudong.suoyouquanBi" class="percentage">
                        <el-input v-model="company9.gerenGudong.suoyouquanBi" maxlength="30" :placeholder="$t('registerOpenAccount.openAccount.common.info.ownership')" /> <!-- $i18n - 所有权百分比 -->
                        <div class="icon-percent" style="left: 95.8%;">%</div>
                      </el-form-item>
                      <div class="block">
                        <el-form-item prop="gerenGudong.birth">
                  ...
                  <div class="formNape">
                    ...
                    <div
                      ...
                      style="    width: 960px;
                                   height: 41px;"
                    >
                      <div v-show="company9.placeAbode.length !== 5" class="add" @click="addelement3()">{{ $t('registerOpenAccount.openAccount.common.taxes.addTaxResidence') }}</div> <!-- $i18n - 添加其他税务居住地 -->
                      <div v-show="company9.placeAbode.length !== 1" class="cancel" @click="removeelement3()">{{ $t('registerOpenAccount.common.btn.delete') }}</div> <!-- $i18n - 删除 -->
                    </div>
                  </div>
                </div>
                ...
                <div class="isBtn right1">
                  <ul>
                    <li class="isyes Motaiteshuchuli" @click="save('company9',3)">{{ $t('registerOpenAccount.common.btn.save') }}</li> <!-- $i18n - 保存 -->
...
export default {
  ...
  data() {
    ...
    var notChinese1 = (rule, value, callback) => {
      if (this.company9.ifmodalBox1 === true || this.company9.ifmodalBox2 === true || this.company9.ifmodalBox) {
    ...
    var validateGeren1 = (rule, value, callback) => {
      const mate = this.company9.ifmodalBox1 === true || this.company9.ifmodalBox2 === true || this.company9.ifmodalBox;
      this.$verify.stairIf(rule, value, mate, callback);
    };
    // 不同国籍
    var validateGeren2 = (rule, value, callback) => {
      const mate = this.company9.juzhudizhi.isguojiButong;
      this.$verify.stairIf(rule, value, mate, callback);
    };
    //  不同出生国
    var validateGeren3 = (rule, value, callback) => {
      const mate = this.company9.juzhudizhi.ischushengguoButong;
      this.$verify.stairIf(rule, value, mate, callback);
    };
    //  是否美国纳税人
    var validateGeren4 = (rule, value, callback) => {
      const mate = this.company9.juzhudizhi.isMeiguoNasuiren === false;
      this.$verify.stairIf(rule, value, mate, callback);
    };
    // 国家-税务居住地-动态渲染
    var validateZJhaoma = (rule, value, callback) => {
      ...
      if (value === '') {
        ...
        for (let i = 0; i < this.company9.placeAbode.length; i++) {
          this.$verify.State(this.company9.placeAbode[i].SWstate3, this.company9.placeAbode[i].taxNumList, this.company9.taxNumList1, _this, this.lang);
        }
        callback();
      }
    };
    ...
    var validateGeren5 = (rule, value, callback) => {
      const array1 = this.company9.placeAbode;
    ...
    var validateSignature = (rule, value, callback) => {
      if (this.company9.ifmodalBox1 === false && this.company9.ifmodalBox2 === false && this.company9.ifmodalBox === false) {
        if (this.company9.shengming.signatureZhanshi === this.company9.shengming.signature) {
          callback();
        } else {
    ...
    var validateGeren7 = (rule, value, callback) => {
      ...
      const guize = /^[0-9]*$/;
      if (this.company9.ifmodalBox1 === true) {
        if (value !== '') {
          if (guize.test(value)) {
      ...
      } else if (this.company9.ifmodalBox2 === true) {
        if (value !== '') {
          if (guize.test(value)) {
      ...
      } else if (this.company9.ifmodalBox === true) {
        if (value !== '') {
          if (guize.test(value)) {
    ...
    var theTaxNo = (rule, value, callback) => {
      if (this.company9.juzhudizhi.isMeiguoNasuiren === false) {
        if (value !== 'N.A.') {
          if (this.company9.identification.SFsignGuojia !== 'CN' ||
              this.company9.identification.SFzhengjianleixing !== 'idCard' ||
              this.company9.identification.SFzhengjianhao === '') {
            this.$verify.notChinese(rule, value, callback);
          } else {
            this.company9.placeAbode.forEach(item => {
              if (item.IDNumber === value) {
                if (item.SWstate3 === 'CN') {
                  if (this.company9.identification.SFzhengjianhao === value) {
                    this.$verify.notChinese(rule, value, callback);
                  } else {
    ...
    return {
      ...
      company9TS: null, // conpany9初始数据暂存 完成表单清空功能
      status: null, // 页面状态 第一次进入为null 第二次更新为非null
      formdata: {},
      rules: {
        // 经营人-验证
  ...
  watch: {
    company9: {
      handler(val, oldVal) {
        ...
        for (let i = 0; i < this.company9.tableTbady25.length; i++) {
          zongBaifenbi1 += parseInt(this.company9.tableTbady25[i].suoyouquan);
        }
        this.company9.suoyouquanZongshu1 = zongBaifenbi1;
        for (let i = 0; i < this.company9.tableTbady10.length; i++) {
          zongBaifenbi2 += parseInt(this.company9.tableTbady10[i].suoyouquan);
        }
        this.company9.suoyouquanZongshu2 = zongBaifenbi2;
        this.ownershipSum = zongBaifenbi1 + zongBaifenbi2;
        // 监听表格length长度
        if (this.company9.isbiaoge25) {
          this.company9.isOne25shouyi = '1';
          this.company9.isbiaodanjinyong1 = false;
        } else {
          this.company9.isOne25shouyi = '2';
          this.company9.isbiaodanjinyong1 = true;
        }
        if (this.company9.isbiaoge10) {
          this.company9.isOne25shouyi1 = '1';
          this.company9.isbiaodanjinyong2 = false;
        } else {
          this.company9.isOne25shouyi1 = '2';
          this.company9.isbiaodanjinyong2 = true;
        }
        // if (this.company9.tableTbady10.length) {
  ...
  methods: {
        ...
        .then(res => {
          if (res.code === 200) {
            if (this.$verify.resStatus(res)) {
              this.company9.authorizedPerson = res.object[0];
            }
    ...
    // 获取用户已填入的信息
    accountCoPersonal() { // 第八页信息填入-股东--纯展示
      this.$http({
        url: '/account/accountCoPersonal/findByAccountId',
        method: 'get',
        params: { personalType: this.company9.personalTypeGR, lang: this.lang, IEgetIssue: this.$verify.timestampRandom() }
      })
        .then(res => {
          if (res.code === 200) {
            if (this.$verify.resStatus(res)) {
              for (let i = 0; i < res.object.length; i++) {
                if (res.object[i].prcentageOfOwnership >= 25) {
                  this.company9.isbiaoge25 = true;
                  this.company9.tableTbady25.push({
                  ...
                  this.company9.isbiaoge10 = true;
                  this.company9.tableTbady10.push({
                    compellation: res.object[i].lastName + ' ' + res.object[i].middleName + ' ' + res.object[i].firstName,
                    suoyouquan: res.object[i].prcentageOfOwnership,
                    username: res.object[i].prcentageOfOwnership,
                    id: res.object[i].id,
      ...
      this.$http({
        ...
        .then(res => {
          if (res.code === 200) {
            if (this.$verify.resStatus(res)) {
              for (let i = 0; i < res.object.length; i++) {
                this.company9.isJingyinren = true;
                this.company9.tableTbady.push({
                  compellation: res.object[i].lastName + ' ' + res.object[i].middleName + ' ' + res.object[i].firstName,
    ...
    accountCoPersonalTwo(personalType) { // 第9页信息填入-股东--可删除
      this.$http({
        url: '/account/accountCoPersonal/findByAccountId',
        method: 'get',
    ...
    getSignature() {
      this.$http({
        url: '/account/accountCoPersonal/findByAccountId',
        method: 'get',
        params: { personalType: this.company9.personalTypeSQR, lang: this.lang, IEgetIssue: this.$verify.timestampRandom() }
      })
        .then(res => {
          if (res.code === 200) {
            if (this.$verify.resStatus(res)) {
              this.company9.shengming.zhanghuName = res.object[0].lastName + ' ' + `${res.object[0].middleName ? res.object[0].middleName + ' ' : res.object[0].middleName + ''}` + res.object[0].firstName;
              this.company9.shengming.riqi = this.$verify.NowDate3();
              this.company9.shengming.signatureZhanshi = res.object[0].lastName + ' ' + `${res.object[0].middleName ? res.object[0].middleName + ' ' : res.object[0].middleName + ''}` + res.object[0].firstName;
              this.company9.shengming.signature = res.object[0].lastName + ' ' + `${res.object[0].middleName ? res.object[0].middleName + ' ' : res.object[0].middleName + ''}` + res.object[0].firstName;
            }
          } else if (res.code === 2003) {
            if (!this.isTokenHint) {
              this.isTokenHint = true;
    ...
    accountCoAddress() {
      ...
      this.$http({
        ...
        .then(res => {
          if (res.code === 200) {
            if (this.$verify.resStatus(res)) {
              this.company9.rezheng.location = res.object[0].address.replace(/-#-/g, ' ');
              this.company9.rezheng.chenshi = res.object[0].city;
              this.company9.rezheng.shengshi = res.object[0].rovince;
              this.company9.rezheng.postcode = res.object[0].zipCode;
              this.company9.rezheng.state = res.object[0].country;
            }
          } else if (res.code === 2003) {
            if (!this.isTokenHint) {
              this.isTokenHint = true;
    ...
    accountCoInstitutional() {
      ...
      this.$http({
        ...
        .then(res => {
          if (res.code === 200) {
            if (this.$verify.resStatus(res)) {
              this.company9.rezheng.companyName = res.object.institutionalName;
            }
          } else if (res.code === 2003) {
            if (!this.isTokenHint) {
              this.isTokenHint = true;
      ...
      this.$http({
        ...
        .then(res => {
          if (res.code === 200) {
            if (this.$verify.resStatus(res)) {
              let companyPosition = '';
              this.company9.rezheng.xing = res.object[0].lastName;
              this.company9.rezheng.zhongjianming = res.object[0].middleName;
              this.company9.rezheng.ming = res.object[0].firstName;
              this.company9.rezheng.suffix = res.object[0].suffix;
              ...
              if (companyPosition === 'mishu') {
                this.company9.rezheng.companyPosition = this.$i18n.t('registerOpenAccount.openAccount.common.info.position.item2'); // $i18n - 秘书
              } else if (companyPosition === 'dongshi') {
                this.company9.rezheng.companyPosition = this.$i18n.t('registerOpenAccount.openAccount.common.info.position.item1'); // $i18n - 董事
              } else if (companyPosition === 'qitaguanyuan') {
                this.company9.rezheng.companyPosition = this.$i18n.t('registerOpenAccount.openAccount.common.info.position.item3'); // $i18n - 其他官员
              }
            }
          } else if (res.code === 2003) {
            if (!this.isTokenHint) {
    ...
    personalType() {
      this.$http({
        ...
        .then(res => {
          if (res.code === 200) {
            console.log(res);
            this.company9.tableTbady = [];
            this.company9.tableTbady25 = [];
            this.company9.tableTbady10 = [];
            // this.company9.personalTypeJ = res.object[4].dictValue;
            // this.company9.personalType25 = res.object[6].dictValue;
            // this.company9.personalType10 = res.object[7].dictValue;
            // this.company9.personalTypeGR = res.object[2].dictValue;
            // this.company9.personalTypeSQR = res.object[1].dictValue;
            this.company9.personalTypeJ = 'operationPrincipal';
            this.company9.personalType25 = '25%AboveBeneficiary';
            this.company9.personalType10 = '10%AboveBeneficiary';
            this.company9.personalTypeGR = 'individualShareholder';
            this.company9.personalTypeSQR = 'authorizedPerson';
            this.accountCoPersonal();
            this.getSignature();
            this.accountCoAddress();
            this.accountCoInstitutional();
            this.accountCoPersonalSQR();
            this.personalTypeTwo(this.company9.personalTypeJ);
            this.accountCoPersonalTwo(this.company9.personalTypeJ);
            this.accountCoPersonalTwo(this.company9.personalType25);
            this.accountCoPersonalTwo(this.company9.personalType10);
          } else if (res.code === 2003) {
            if (!this.isTokenHint) {
              this.isTokenHint = true;
              this.$verify.staleDated(this);
    ...
    taxIdentificationNumber() {
      this.$http({
        ...
        .then(res => {
          if (res.code === 200) {
            this.company9.placeAbode[0].taxNumList = JSON.parse(JSON.stringify(res.object));
            this.company9.taxNumList1 = JSON.parse(JSON.stringify(res.object));
          } else if (res.code === 2003) {
            if (!this.isTokenHint) {
              this.isTokenHint = true;
              this.$verify.staleDated(this);
    ...
    addressType() {
      this.$http({
        ...
        .then(res => {
          if (res.code === 200) {
            this.company9.addressType = res.object[0].dictValue;
          } else if (res.code === 2003) {
            if (!this.isTokenHint) {
              this.isTokenHint = true;
              this.$verify.staleDated(this);
    ...
    // 经营添加 25添加 10添加
    addelement(index) {
      this.company9TS = JSON.parse(JSON.stringify(this.company9));
      // 完成已填写的股东赋值到下拉框
      ...
      for (let i = 0; i < this.company9.tableTbady25.length; i++) {
        indexTS++;
        const obj = {
          SYRname: this.company9.tableTbady25[i].compellation,
          SYRvalue: indexTS,
          id: this.company9.tableTbady25[i].id,
          Type: this.company9.personalType25
        };
      ...
      for (let i = 0; i < this.company9.tableTbady10.length; i++) {
        indexTS++;
        const obj = {
          SYRname: this.company9.tableTbady10[i].compellation,
          SYRvalue: indexTS,
          id: this.company9.tableTbady10[i].id,
          Type: this.company9.personalType10
        };
        beneficiaryNameListTS.push(JSON.parse(JSON.stringify(obj)));
      }
      if (this.company9.authorizedPerson !== null) {
        indexTS++;
        const obj = {
          SYRname: this.company9.authorizedPerson.lastName + ' ' + this.company9.authorizedPerson.middleName + ' ' + this.company9.authorizedPerson.firstName,
          id: this.company9.authorizedPerson.id,
          SYRvalue: indexTS,
          Type: 'authorizedPerson'
        };
        beneficiaryNameListTS.push(JSON.parse(JSON.stringify(obj)));
      }
      this.company9.xuanzeren1.beneficiaryNameList = beneficiaryNameListTS;
      if (index === 1) {
        this.company9.ifmodalBox = true;
        this.company9.ismodalBox1Cot = true;
      } else if (index === 2) {
        this.company9.ifmodalBox1 = true;
        this.company9.ismodalBox2Cot = true;
      } else if (index === 3) {
        this.company9.ifmodalBox2 = true;
        this.company9.ismodalBox3Cot = true;
      }
      this.company9.isbottomBox = false;
    },
    removePersonalTypeJ(id) { // 股东删除功能
      this.$http({
        url: '/openAccount/company/removeNine',
        method: 'put',
        params: { id }
      })
        .then(res => {
    ...
    taxIsBtn(VerifyPath) {
      ...
      const timerId = setInterval(() => {
        num--;
        this.$refs.company9.validateField(VerifyPath);
        if (num === 0) {
    ...
    addelement3() {
      this.company9.placeAbode.push({
        ...
        isSuiwuNO: false, // is 税务识别号
        suiwuQita: '',
        taxNumList: JSON.parse(JSON.stringify(this.company9.taxNumList1)) // 页面上使用
      });
    },
    removeelement3() {
      this.company9.placeAbode.pop(this.company9.placeAbode);
    },
    // 模态框 -保存
    save(formName, index) {
      this.$refs[formName].validate(valid => {
        if (valid) {
          if (index === 1) {
            if (this.company9.xuanzeren1.beneficiaryName === 'NotListed') {
              this.arrPush(this.company9.personalTypeJ);
            } else {
              this.company9.xuanzeren1.beneficiaryNameList.forEach(item => {
                if (this.company9.xuanzeren1.beneficiaryName === item.SYRvalue) {
                  this.operatorExtra(item);
                }
              });
              const company9TS = JSON.parse(JSON.stringify(this.company9TS));
              this.company9.xuanzeren1 = company9TS.xuanzeren1;
              this.company9.gerenGudong = company9TS.gerenGudong;
              this.company9.juzhudizhi = company9TS.juzhudizhi;
              this.company9.identification = company9TS.identification;
              this.company9.placeAbode = company9TS.placeAbode;
            }
            this.company9.ifmodalBox = false;
            this.company9.isJingyinren = true;
            this.company9.isbottomBox = true;
          } else if (index === 2) {
            this.arrPush(this.company9.personalType25);
            this.company9.ifmodalBox1 = false;
            this.company9.isbiaoge25 = true;
            this.company9.isbottomBox = true;
          } else if (index === 3) {
            this.arrPush(this.company9.personalType10);
            this.company9.ifmodalBox2 = false;
            this.company9.isbiaoge10 = true;
            this.company9.isbottomBox = true;
          }
        }
    ...
    operatorExtra(item) { // 经营负责人已列出处理
      this.$http({
        url: '/openAccount/company/updatePersonalByPrimaryKeySelective',
        method: 'post',
        params: { id: item.id, position: this.company9.xuanzeren1.zhiwei, personalTypeTwo: 'operationPrincipal' }
      })
        .then(res => {
          if (res.code === 200) {
    ...
    arrPush(gdType) { // gdType 个人类型
      ...
      let accountCoPersonal = {}; // 公司个人信息
      const accountCoAddressList = []; // 公司地址信息
      let accountCoIdentity = {}; // 公司身份信息
      const accountCoTaxesList = []; // 公司税务居住地
      const companyBeneficiaryOwnersInfoModelList = [];

      let isBusinessManager = false; // 是否 经营负责人 需要判断
      let prcentageOfOwnership = null; // 所有权百分比 需判断

      if (gdType === this.company9.personalTypeJ) { // 如果类型为经验负责人
        isBusinessManager = true;
        if (this.company9.gerenGudong.issuoyouquanBi) {
          prcentageOfOwnership = this.company9.gerenGudong.suoyouquanBi;
        } else {
          prcentageOfOwnership = 0;
        }
      } else if (gdType === this.company9.personalType25) { // 如果类型为25
        isBusinessManager = false;
        prcentageOfOwnership = this.company9.gerenGudong.suoyouquanBi;
      } else if (gdType === this.company9.personalType10) { // 如果类型为10
        isBusinessManager = false;
        prcentageOfOwnership = this.company9.gerenGudong.suoyouquanBi;
      }
      accountCoPersonal = { // 公司个人信息
        accountId,
        createdBy,
        createdDate,
        appellation: this.company9.gerenGudong.companyName,
        birthCountry: this.company9.juzhudizhi.state1,
        birthday: this.$verify.NowDate2(this.company9.gerenGudong.birth),
        firstName: this.company9.gerenGudong.surname,
        middleName: this.company9.gerenGudong.middle,
        lastName: this.company9.gerenGudong.call,
        suffix: this.company9.gerenGudong.suffix,
        position: this.company9.gerenGudong.zhiwei44,

        isAmericanTaxpayer: this.company9.juzhudizhi.isMeiguoNasuiren,
        isBusinessManager, // 是否 经营负责人 需要判断
        nationality: this.company9.juzhudizhi.state1,
        personalType: gdType,
        prcentageOfOwnership // 所有权百分比 需判断
      };
      accountCoAddressList.push({ // 公司地址信息
        accountId,
        createdBy,
        createdDate,
        address: this.company9.juzhudizhi.dizhi1 ? this.company9.juzhudizhi.dizhi + '-#-' + this.company9.juzhudizhi.dizhi1 : this.company9.juzhudizhi.dizhi,
        addressType: this.company9.addressType, // 地址类型需获取
        city: this.company9.juzhudizhi.chengshi,
        country: this.company9.juzhudizhi.state1,
        otherBirthCountry: this.company9.juzhudizhi.ischushengguoButong ? this.company9.juzhudizhi.chushengguo : null,
        otherCountry: this.company9.juzhudizhi.isguojiButong ? this.company9.juzhudizhi.guoji : null,
        rovince: this.company9.juzhudizhi.province,
        zipCode: this.company9.juzhudizhi.youbian
      });
      accountCoIdentity = { // 公司身份信息
        accountId,
        createdBy,
        createdDate,
        idCardType: this.company9.identification.SFzhengjianleixing,
        issuingCountry: this.company9.identification.SFsignGuojia,
        idNumber: this.company9.identification.SFzhengjianhao
      };
      let noTaxIdentificationNumber = null;
      for (let i = 0; i < this.company9.placeAbode.length; i++) { // 公司税务居住地
        if (this.company9.placeAbode[i].isSuiwuNO) {
          if (this.company9.placeAbode[i].suibie === 'qita') {
            noTaxIdentificationNumber = this.company9.placeAbode[i].suiwuQita;
          } else {
            noTaxIdentificationNumber = this.company9.placeAbode[i].suibie;
          }
        }
        accountCoTaxesList.push(
          {
            ...
            createdBy,
            createdDate,
            taxResidenceCountry: this.company9.placeAbode[i].SWstate3,
            taxResidenceIdCardNumber: this.company9.placeAbode[i].IDNumber,
            noTaxIdentificationNumber
          }
        );
      }
      companyBeneficiaryOwnersInfoModelList.push(
        {
          accountCoPersonal,
      ...
      this.addExperiencedBenefitPerson(companyBeneficiaryOwnersInfoModelList);
    },
    addExperiencedBenefitPerson(companyBeneficiaryOwnersInfoModelList) {
      const data = {
        status: this.status,
        companyBeneficiaryOwnersInfoModelList
      };
      this.$http({
        url: '/openAccount/company/saveNine',
        method: 'post',
        data
      })
        .then(res => {
    ...
    // 提交
    submitForm(formName) {
      if (this.company9.tableTbady.length === 0) {
    ...
    submitFormData() {
      this.$http({
        url: '/openAccount/company/saveNinePage',
        method: 'post',
