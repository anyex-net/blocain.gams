            ...
            <div class="formContent">
              <div class="formNape">
                ...
                <div class="formNapeContent">
                  <!-- item -->
                  <div
                    v-for="(item,index) in company4.regulatoryInfoList"
                    :key="index"
                    class="isBtn"
                  >
                    <ul ref="istext">
                    ...
                    <div v-show="item.isbtnStyle" v-if="item.dictValue=='are its shares traded on regulated exchanges?Is the organization a publicly held entity?'" class="BtnContent">
                      <div v-if="item.isbtnStyle" class="top20 fade">
                        ...
                        <el-form-item
                          v-for="(item1,index1) in company4.big.jiaoyitiaomu15"
                          :key="index1"
                        >
                          <el-col :span="7">
                            <el-form-item
                      ...
                      <div
                        ...
                        style="    width: 960px;
                                       height: 41px;"
                      >
                        <div v-show="company4.big.jiaoyitiaomu15.length !== 5" class="add" @click="addElement(company4.big.jiaoyitiaomu15,'1')">{{ $t('registerOpenAccount.openAccount.common.regulate.entity.btnBourse') }}</div> <!-- $i18n - 添加交易所条目 -->
                        <div v-show="company4.big.jiaoyitiaomu15.length !== 1" class="cancel" @click="removeElement(company4.big.jiaoyitiaomu15)">{{ $t('registerOpenAccount.common.btn.delete') }}</div> <!-- $i18n - 删除 -->
                      </div>
                    </div>
                    <!-- 17 -->
                      ...
                      <transition name="fade">
                        <div v-if="item.isbtnStyle" class="fade">
                          ...
                          <el-form-item prop="big.jiaoyitiaomu16.xiangqing">
                            <el-input
                              v-model="company4.big.jiaoyitiaomu16.xiangqing"
                              maxlength="64"
                      ...
                      <transition name="fade">
                        <div v-if="item.isbtnStyle" class="fade">
                          ...
                          <el-form-item prop="big.jiaoyitiaomu17.jiaoyisuoName">
                            <el-input
                              v-model="company4.big.jiaoyitiaomu17.jiaoyisuoName"
                              maxlength="30"
                              :placeholder="$t('registerOpenAccount.common.formPrompt.required')"
                            /> <!-- $i18n - 必填 -->
                          </el-form-item>
                      ...
                      <transition name="fade">
                        <div v-if="item.isbtnStyle" class="fade">
                          ...
                          <el-form-item prop="big.jiaoyitiaomu17.xiangqing">
                            <el-input
                              v-model="company4.big.jiaoyitiaomu17.xiangqing"
                              maxlength="64"
                              :placeholder="$t('registerOpenAccount.common.formPrompt.required')"
                            /> <!-- $i18n - 必填 -->
                          </el-form-item>
                      ...
                      <transition name="fade">
                        <div v-if="item.isbtnStyle">
                          ...
                          <el-form-item prop="big.jiaoyitiaomu18.xiangqing">
                            <el-input
                              v-model="company4.big.jiaoyitiaomu18.xiangqing"
                              maxlength="64"
                              :placeholder="$t('registerOpenAccount.common.formPrompt.required')"
                            /> <!-- $i18n - 必填 -->
                          </el-form-item>
                      ...
                      <transition name="fade">
                        <div v-if="item.isbtnStyle" class="fade">
                          ...
                          <el-form-item prop="big.jiaoyitiaomu19.daima">
                            <el-input v-model="company4.big.jiaoyitiaomu19.daima" maxlength="30" :placeholder="$t('registerOpenAccount.common.formPrompt.required')" /> <!-- $i18n - 必填 -->
                          </el-form-item>
                        </div>
                      </transition>
                    </div>
                      ...
                      <transition name="fade">
                        <div v-if="item.isbtnStyle" class="fade">
                          <el-form-item prop="big.jiaoyitiaomu20.guzhuXiang">
                            <el-input v-model="company4.big.jiaoyitiaomu20.guzhuXiang" maxlength="64" :placeholder="$t('registerOpenAccount.openAccount.common.regulate.employee.name')" /> <!-- $i18n - 公司名称 -->
                          </el-form-item>
                          <el-form-item prop="big.jiaoyitiaomu20.state">
                            <el-select v-model="company4.big.jiaoyitiaomu20.state" :no-match-text="$t('account.manage.no_data')" maxlength="30" filterable :placeholder="$t('registerOpenAccount.openAccount.common.regulate.employee.state')"> <!-- $i18n - 公司 国家/地区 -->
                              <dictionary dict-code="country" />
                            </el-select>
                          </el-form-item>
                          <el-form-item prop="big.jiaoyitiaomu20.site">
                            <el-input v-model="company4.big.jiaoyitiaomu20.site" maxlength="64" :placeholder="$t('registerOpenAccount.openAccount.common.regulate.employee.site')" /> <!-- $i18n - 公司 地址（如果空间不足，请转下行） -->
                          </el-form-item>
                          <el-form-item prop="big.jiaoyitiaomu20.site1">
                            <el-input v-model="company4.big.jiaoyitiaomu20.site1" maxlength="64" :placeholder="$t('registerOpenAccount.openAccount.common.regulate.employee.site1')" /> <!-- $i18n - 公司 （接上行） -->
                          </el-form-item>
                          <el-form-item prop="big.jiaoyitiaomu20.city">
                            <el-input v-model="company4.big.jiaoyitiaomu20.city" maxlength="30" :placeholder="$t('registerOpenAccount.openAccount.common.regulate.employee.city')" /> <!-- $i18n - 公司 城市 -->
                          </el-form-item>
                          <el-form-item prop="big.jiaoyitiaomu20.province">
                            <el-input v-model="company4.big.jiaoyitiaomu20.province" maxlength="30" :placeholder="$t('registerOpenAccount.openAccount.common.regulate.employee.province')" /> <!-- $i18n - 公司 省/市 -->
                          </el-form-item>
                          <el-form-item prop="big.jiaoyitiaomu20.postalCode">
                            <el-input v-model="company4.big.jiaoyitiaomu20.postalCode" maxlength="20" :placeholder="$t('registerOpenAccount.openAccount.common.regulate.employee.postcode')" /> <!-- $i18n - 公司 邮政编码 -->
                          </el-form-item>
                          <el-form-item prop="big.jiaoyitiaomu20.postalAddress">
                            <el-input v-model="company4.big.jiaoyitiaomu20.postalAddress" maxlength="64" :placeholder="$t('registerOpenAccount.openAccount.common.regulate.employee.email')" /> <!-- $i18n - 电邮地址 -->
                          </el-form-item>
                          <el-form-item prop="big.jiaoyitiaomu20.phoneNumber">
                            <el-input v-model="company4.big.jiaoyitiaomu20.phoneNumber" maxlength="11" :placeholder="$t('registerOpenAccount.openAccount.common.regulate.employee.number')" /> <!-- $i18n - 电话号码 -->
                          </el-form-item>
                          <el-form-item prop="big.jiaoyitiaomu20.zhuceName">
                            <el-input
                              v-model="company4.big.jiaoyitiaomu20.zhuceName"
                              maxlength="30"
                          ...
                          <el-form-item prop="big.jiaoyitiaomu20.zhuceGuanxi">
                            <el-input
                              v-model="company4.big.jiaoyitiaomu20.zhuceGuanxi"
                              maxlength="30"
...
export default {
  ...
  methods: {
    ...
    accountCoRegulatory() {
      this.$http({
        url: '/account/accountCoRegulatory/findByAccountId',
        method: 'get',
        ...
        .then(res => {
          if (res.code === 200) {
            if (this.$verify.resStatus(res)) {
              this.newValue.accountCoInstitutional = res.object;
              let infoDetails = null;
              for (let i = 0; i < res.object.length; i++) {
                this.company4.regulatoryInfoList.forEach(item => {
                  if (item.dictValue === res.object[i].infoType) {
                    ...
                    if (res.object[i].infoDetails !== '') {
                      if (res.object[i].infoType === 'foreignBank (established and operated outside the United States)') {
                        ...
                        infoDetails = JSON.parse(res.object[i].infoDetails);
                        this.company4.big.jiaoyitiaomu15 = infoDetails.jiaoyitiaomu15;
                      } else if (res.object[i].infoType === 'whether institutions need in accordance with article 1101 of the us futures association (NFA), registered in the commodity futures trading commission, or investment securities association (IDA) registered in Canada, or in other foreign registered as futures agents, brokers, commodity fund managers and commodity trading advisors, retail traders or leveraged trader?') {
                        infoDetails = JSON.parse(res.object[i].infoDetails);
                        this.company4.big.jiaoyitiaomu16.xiangqing = infoDetails.xiangqing;
                        ...
                        infoDetails = JSON.parse(res.object[i].infoDetails);
                        this.company4.big.jiaoyitiaomu17.jiaoyisuoName = infoDetails.jiaoyisuoName;
                        this.company4.big.jiaoyitiaomu17.xiangqing = infoDetails.xiangqing;
                        ...
                        infoDetails = JSON.parse(res.object[i].infoDetails);
                        this.company4.big.jiaoyitiaomu18.xiangqing = infoDetails.xiangqing;
                        ...
                        infoDetails = JSON.parse(res.object[i].infoDetails);
                        this.company4.big.jiaoyitiaomu19.daima = infoDetails.daima;
                        ...
                        infoDetails = JSON.parse(res.object[i].infoDetails);
                        this.company4.big.jiaoyitiaomu20.guzhuXiang = infoDetails.guzhuXiang;
                        this.company4.big.jiaoyitiaomu20.state = infoDetails.state;
                        this.company4.big.jiaoyitiaomu20.site = infoDetails.site;
                        this.company4.big.jiaoyitiaomu20.site1 = infoDetails.site1;
                        this.company4.big.jiaoyitiaomu20.city = infoDetails.city;
                        this.company4.big.jiaoyitiaomu20.province = infoDetails.province;
                        this.company4.big.jiaoyitiaomu20.postalCode = infoDetails.postalCode;
                        this.company4.big.jiaoyitiaomu20.postalAddress = infoDetails.postalAddress;
                        this.company4.big.jiaoyitiaomu20.phoneNumber = infoDetails.phoneNumber;
                        this.company4.big.jiaoyitiaomu20.zhuceName = infoDetails.zhuceName;
                        this.company4.big.jiaoyitiaomu20.zhuceGuanxi = infoDetails.zhuceGuanxi;
                      }
                    }
                  }
                });
      ...
      this.$http({
        ...
        .then(res => {
          if (res.code === 200) {
            ...
            this.company4.regulatoryInfoList = JSON.parse(
    ...
    submitFormData() {
      ...
      let infoDetails = null;
      if (this.newValue.accountCoInstitutional === null) {
        // 1.公司规管信息  //暂定
        for (let i = 0; i < this.company4.regulatoryInfoList.length; i++) {
          if (this.company4.regulatoryInfoList[i].dictValue === 'foreignBank (established and operated outside the United States)') {
            infoDetails = this.company4.regulatoryInfoList[i].isbtnStyle
              ? JSON.stringify(
                {
                  min1: this.company4.regulatoryInfoList[i].isbtnStyle1,
                  min2: this.company4.regulatoryInfoList[i].isbtnStyle2,
                  min3: this.company4.regulatoryInfoList[i].isbtnStyle3
                }
              ) : null;
          } else if (this.company4.regulatoryInfoList[i].dictValue === 'are its shares traded on regulated exchanges?Is the organization a publicly held entity?') {
            infoDetails = this.company4.regulatoryInfoList[i].isbtnStyle
              ? JSON.stringify(
                {
                  jiaoyitiaomu15: this.company4.big.jiaoyitiaomu15
                }
              ) : null;
          } else if (this.company4.regulatoryInfoList[i].dictValue === 'whether institutions need in accordance with article 1101 of the us futures association (NFA), registered in the commodity futures trading commission, or investment securities association (IDA) registered in Canada, or in other foreign registered as futures agents, brokers, commodity fund managers and commodity trading advisors, retail traders or leveraged trader?') {
            infoDetails = this.company4.regulatoryInfoList[i].isbtnStyle
              ? JSON.stringify(
                {
                  xiangqing: this.company4.big.jiaoyitiaomu16.xiangqing
                }
              ) : null;
          } else if (this.company4.regulatoryInfoList[i].dictValue === 'is the institution a member of the exchange, regulatory/self-regulatory authority, or a relevant or related person who is a member of the exchange?') {
            infoDetails = this.company4.regulatoryInfoList[i].isbtnStyle
              ? JSON.stringify(
                {
                  jiaoyisuoName: this.company4.big.jiaoyitiaomu17.jiaoyisuoName,
                  xiangqing: this.company4.big.jiaoyitiaomu17.xiangqing
                }
              ) : null;
          } else if (this.company4.regulatoryInfoList[i].dictValue === 'has any principal, officer, authorized trader or other person listed in the account been arrested or convicted of a crime?') {
            infoDetails = this.company4.regulatoryInfoList[i].isbtnStyle
              ? JSON.stringify(
                {
                  xiangqing: this.company4.big.jiaoyitiaomu18.xiangqing
                }
              ) : null;
          } else if (this.company4.regulatoryInfoList[i].dictValue === 'are the account holders or any of their officers: I) directors of the listed company, ii) shareholders holding 10% of the shares, or iii) decision makers?') {
            infoDetails = this.company4.regulatoryInfoList[i].isbtnStyle
              ? JSON.stringify(
                {
                  daima: this.company4.big.jiaoyitiaomu19.daima
                }
              ) : null;
          } else if (this.company4.regulatoryInfoList[i].dictValue === 'whether any principal or authorized trader of the institution is a registered broker;An employee, director or owner of a securities or commodity brokerage company;Employees of Banks, hedge funds or other financial services companies?') {
            infoDetails = this.company4.regulatoryInfoList[i].isbtnStyle
              ? JSON.stringify(
                {
                  guzhuXiang: this.company4.big.jiaoyitiaomu20.guzhuXiang,
                  state: this.company4.big.jiaoyitiaomu20.state,
                  site: this.company4.big.jiaoyitiaomu20.site,
                  site1: this.company4.big.jiaoyitiaomu20.site1,
                  city: this.company4.big.jiaoyitiaomu20.city,
                  province: this.company4.big.jiaoyitiaomu20.province,
                  postalCode: this.company4.big.jiaoyitiaomu20.postalCode,
                  postalAddress: this.company4.big.jiaoyitiaomu20.postalAddress,
                  phoneNumber: this.company4.big.jiaoyitiaomu20.phoneNumber,
                  zhuceName: this.company4.big.jiaoyitiaomu20.zhuceName,
                  zhuceGuanxi: this.company4.big.jiaoyitiaomu20.zhuceGuanxi
                }
              ) : null;
          }
          data.push(
            {
              ...
              createdBy,
              createdDate,
              // id: this.company4.regulatoryInfoList[i].id,
              infoType: this.company4.regulatoryInfoList[i].dictValue,
              whether: this.company4.regulatoryInfoList[i].isbtnStyle,
              infoDetails
            }
          );
          infoDetails = null;
        ...
        for (let i = 0; i < this.newValue.accountCoInstitutional.length; i++) {
          this.company4.regulatoryInfoList.forEach(item => {
            if (this.newValue.accountCoInstitutional[i].infoType === item.dictValue) { // 如果项的value对应，说明id对应上每一项了
              this.newValue.accountCoInstitutional[i].whether = item.isbtnStyle;
              if (this.newValue.accountCoInstitutional[i].infoType === 'foreignBank (established and operated outside the United States)' &&
                    item.dictValue === 'foreignBank (established and operated outside the United States)'
              ) { // vlaue 如果是有子表单的 额外处理
                this.newValue.accountCoInstitutional[i].infoDetails = item.isbtnStyle
                  ? JSON.stringify(
                    {
              ...
              } else if (this.newValue.accountCoInstitutional[i].infoType === 'are its shares traded on regulated exchanges?Is the organization a publicly held entity?' &&
              ...
              } else if (this.newValue.accountCoInstitutional[i].infoType === 'whether institutions need in accordance with article 1101 of the us futures association (NFA), registered in the commodity futures trading commission, or investment securities association (IDA) registered in Canada, or in other foreign registered as futures agents, brokers, commodity fund managers and commodity trading advisors, retail traders or leveraged trader?' &&
              ...
              } else if (this.newValue.accountCoInstitutional[i].infoType === 'is the institution a member of the exchange, regulatory/self-regulatory authority, or a relevant or related person who is a member of the exchange?' &&
              ...
              } else if (this.newValue.accountCoInstitutional[i].infoType === 'has any principal, officer, authorized trader or other person listed in the account been arrested or convicted of a crime?' &&
              ...
              } else if (this.newValue.accountCoInstitutional[i].infoType === 'are the account holders or any of their officers: I) directors of the listed company, ii) shareholders holding 10% of the shares, or iii) decision makers?' &&
              ...
              } else if (this.newValue.accountCoInstitutional[i].infoType === 'whether any principal or authorized trader of the institution is a registered broker;An employee, director or owner of a securities or commodity brokerage company;Employees of Banks, hedge funds or other financial services companies?' &&
        ...
        data = this.newValue.accountCoInstitutional;
      }
      this.$http({
        url: '/openAccount/company/saveFour',
        method: 'post',
        data
      })
        .then(res => {
