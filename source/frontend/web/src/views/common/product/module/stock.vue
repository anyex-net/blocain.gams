<template>
  <div class="app-container">
    <div class="product-wrapper">
      ...
      <el-table :data="stockData" :empty-text="$t('common.product.no_data')" class="product-table"> <!--无数据-->
        <el-table-column prop="stockCode" :label="$t('common.product.stocks.code')" /><!--股票代码-->
        ...
        <el-table-column prop="high" :label="$t('common.product.high')" align="right"><!--最高价-->
          <template slot-scope="scope">
            <span>{{ scope.row.high | keepNumTwo }}</span>
          </template>
        </el-table-column>
        <el-table-column prop="low" :label="$t('common.product.low')" align="right"><!--最低价-->
          <template slot-scope="scope">
            <span>{{ scope.row.low | keepNumTwo }}</span>
          </template>
        </el-table-column>
        <el-table-column prop="volume" :label="$t('common.product.volume')" align="right" /><!--成交量-->
      </el-table>
      <el-pagination
...
<style lang="scss">
  .product-wrapper {
    ...
    .el-tabs__item.is-active {
      ...
      background-color: rgba(255,62,77,1)!important;
    }
    .el-tabs__item:hover {
