<template>
  <div class="app-container">
    ...
    <el-table v-loading="IbAccountMarketValueHisLoading" :data="IbAccountMarketValueHisData" style="width:100%;margin-bottom:20px;" border row-key="id" highlight-current-row>
      ...
      <el-table-column prop="createDate" width="120" label="创建时间" />
    ...
    <el-dialog title="当日盈亏" :visible.sync="IbAccountMarketValueHisDialog" width="660px">
      <el-form ref="IbAccountMarketValueHisForm" :inline="true" :model="IbAccountMarketValueHisForm" :rules="IbAccountMarketValueHisPnLRules" label-width="100px" class="IbAccountMarketValueHisForm">
        <el-form-item label="账户ID" prop="accountId">
          <el-input v-model="IbAccountMarketValueHisForm.accountId" />
        </el-form-item>
        <el-form-item label="IB账户代码" prop="accountCode">
          <el-input v-model="IbAccountMarketValueHisForm.accountCode" />
        </el-form-item>
        <el-form-item label="币种" prop="currency">
          <el-select v-model="IbAccountMarketValueHisForm.currency" placeholder="请选择币种" value="" style="width: 180px;">
        ...
        <el-form-item label="总计现金" prop="totalCashBalance">
          <el-input v-model="IbAccountMarketValueHisForm.totalCashBalance" />
        </el-form-item>
        <el-form-item label="已结算现金" prop="cashBalance">
          <el-input v-model="IbAccountMarketValueHisForm.cashBalance" />
        </el-form-item>
        <el-form-item label="应计现金" prop="accruedCash">
          <el-input v-model="IbAccountMarketValueHisForm.accruedCash" />
        </el-form-item>
        <el-form-item label="股票" prop="stockMarketValue">
          <el-input v-model="IbAccountMarketValueHisForm.stockMarketValue" />
        </el-form-item>
        <el-form-item label="期权" prop="optionMarketValue">
          <el-input v-model="IbAccountMarketValueHisForm.optionMarketValue" />
        </el-form-item>
        <el-form-item label="期货期权" prop="futureOptionValue">
          <el-input v-model="IbAccountMarketValueHisForm.futureOptionValue" />
        </el-form-item>
        <el-form-item label="期货" prop="futuresPnl">
          <el-input v-model="IbAccountMarketValueHisForm.futuresPnl" />
        </el-form-item>
        <el-form-item label="净清算折算货币" prop="netLiquidationByCurrency">
          <el-input v-model="IbAccountMarketValueHisForm.netLiquidationByCurrency" />
        </el-form-item>
        <el-form-item label="基金" prop="fundValue">
          <el-input v-model="IbAccountMarketValueHisForm.fundValue" />
        </el-form-item>
        <el-form-item label="应计股息" prop="netDividend">
          <el-input v-model="IbAccountMarketValueHisForm.netDividend" />
        </el-form-item>
        <el-form-item label="共同基金" prop="mutualFundValue">
          <el-input v-model="IbAccountMarketValueHisForm.mutualFundValue" />
        </el-form-item>
        <el-form-item label="货币市场基金" prop="moneyMarketFundValue">
          <el-input v-model="IbAccountMarketValueHisForm.moneyMarketFundValue" />
        </el-form-item>
        <el-form-item label="公司债" prop="corporateBondValue">
          <el-input v-model="IbAccountMarketValueHisForm.corporateBondValue" />
        </el-form-item>
        <el-form-item label="长期国债" prop="tBondValue">
          <el-input v-model="IbAccountMarketValueHisForm.tBondValue" />
        </el-form-item>
        <el-form-item label="短期国债" prop="tBillValue">
          <el-input v-model="IbAccountMarketValueHisForm.tBillValue" />
        </el-form-item>
        <el-form-item label="权证" prop="warrantValue">
          <el-input v-model="IbAccountMarketValueHisForm.warrantValue" />
        </el-form-item>
        <el-form-item label="外汇现金" prop="fxCashBalance">
          <el-input v-model="IbAccountMarketValueHisForm.fxCashBalance" />
        </el-form-item>
        <el-form-item label="账户或分组" prop="accountOrGroup">
          <el-input v-model="IbAccountMarketValueHisForm.accountOrGroup" />
        </el-form-item>
        <el-form-item label="实际币种" prop="realCurrency">
          <el-select v-model="IbAccountMarketValueHisForm.realCurrency" placeholder="请选择实际币种" value="" style="width: 180px;">
            <el-option v-for="data in baseCurrencyData" :key="data.id" :label="data.dictDest" :value="data.dictValue">
              <span style="float:left;">{{ data.dictValue }}</span>
              <span style="float:right">{{ data.dictDest }}</span>
            </el-option>
        ...
        <el-form-item label="发行方期权" prop="issuerOptionValue">
          <el-input v-model="IbAccountMarketValueHisForm.issuerOptionValue" />
        </el-form-item>
        <el-form-item label="未实现盈亏" prop="unrealizedPnl">
          <el-input v-model="IbAccountMarketValueHisForm.unrealizedPnl" />
        </el-form-item>
        <el-form-item label="已实现盈亏" prop="realizedPnl">
          <el-input v-model="IbAccountMarketValueHisForm.realizedPnl" />
        </el-form-item>
        <el-form-item label="汇率" prop="exchangeRate">
          <el-input v-model="IbAccountMarketValueHisForm.exchangeRate" />
        </el-form-item>
        <el-divider></el-divider>
        <el-form-item>
          <el-button type="primary" @click="doSubmit('IbAccountMarketValueHisForm')">提交</el-button>
        </el-form-item>
...
export default {
  ...
  data() {
    return {
      IbAccountMarketValueHisLoading: '',
      IbAccountMarketValueHisData: [],
      baseCurrencyData: [],
      exchangeData: [],
      IbAccountMarketValueHisDialog: false,
      IbAccountMarketValueHisForm: {
        id: '',
        accountId: '',
        accountCode: '',
        totalCashBalance: '',
      ...
      IbAccountMarketValueHisPnLRules: {
        accountId: [
        ...
        realCurrency: [
          { required: false, message: '请选择实际币种', trigger: 'change' }
        ],
        issuerOptionValue: [
  ...
  methods: {
    ...
    dialogAdd() {
      this.IbAccountMarketValueHisForm = {
        id: '',
        accountId: '',
        accountCode: '',
        totalCashBalance: '',
      ...
      if (this.$refs.IbAccountMarketValueHisForm) {
        this.$refs.IbAccountMarketValueHisForm.resetFields();
      }
      this.IbAccountMarketValueHisDialog = true;
    },
    dialogEdit: function(row, column) {
      ...
      this.$http({
        url: '/ib/ibAccountMarketValueHis/findBy',
        method: 'get',
        params: {
          'id': column.id
        }
    ...
    doSubmit: function(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          this.$http({
            url: '/ib/ibAccountMarketValueHis/save',
            method: 'post',
            params: this.IbAccountMarketValueHisForm
          }).then(res => {
            if (res.code === 200) {
          ...
          this.IbAccountMarketValueHisDialog = false;
        }
      });
    },
    doDelete: function(row, column) {
      this.$confirm('确认删除, 是否继续?', '提示', {
        ...
        this.$http({
          url: '/ib/ibAccountMarketValueHis/del',
          method: 'post',
          params: {
            ids: column.id
          }
    ...
    doSearch: function(page) {
      ...
      this.$refs.searchForm.validate((valid) => {
        if (valid) {
          this.IbAccountMarketValueHisLoading = true;
          this.$http({
            url: '/ib/ibAccountMarketValueHis/data',
            method: 'post',
            params: Object.assign(this.pageParams, this.searchForm)
          }).then(res => {
            if (res.code === 200) {
              this.IbAccountMarketValueHisData = res.rows;
              this.pageParams.totalPage = res.totalPage;
              this.IbAccountMarketValueHisLoading = false;
            }
          }).catch(error => {
            this.$message.error(error);
          });
